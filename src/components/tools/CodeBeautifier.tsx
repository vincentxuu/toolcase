  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2 items-center flex-wrap">
        <button className="inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--color-primary)] text-white rounded-lg font-medium cursor-pointer transition-colors hover:bg-[var(--color-primary-hover)] border-0" onClick={handleBeautify}>{l.beautify}</button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginLeft: 'auto' }}>
          <label className="text-sm text-[var(--color-text-secondary)]">{l.indentSize}:</label>
          <select
            value={indentSize}
