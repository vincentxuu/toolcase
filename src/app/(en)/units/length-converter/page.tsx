...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/units/length-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Length Converter', url: 'https://toolcase.cc/units/length-converter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/units/length-converter"
