...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/units/time-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Time Converter', url: 'https://toolcase.cc/units/time-converter' },
        ]}
      />
      <ToolSchema
        name="Time Converter"
        ...
        url="https://toolcase.cc/units/time-converter"
