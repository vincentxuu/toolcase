...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/units/volume-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Volume Converter', url: 'https://toolcase.cc/units/volume-converter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/units/volume-converter"
