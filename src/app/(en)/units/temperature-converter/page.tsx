...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/units/temperature-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Temperature Converter', url: 'https://toolcase.cc/units/temperature-converter' },
        ]}
      />
      <ToolSchema
        name="Temperature Converter"
        description="Convert between Celsius, Fahrenheit, and Kelvin. Free online temperature converter with instant results."
        url="https://toolcase.cc/units/temperature-converter"
