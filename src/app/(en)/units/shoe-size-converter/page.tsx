...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/units/shoe-size-converter', languages: { en: 'https://toolcase.cc/units/shoe-size-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/shoe-size-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Shoe Size Converter', url: 'https://toolcase.cc/units/shoe-size-converter' },
        ]}
      />
      <ToolSchema
        name="Shoe Size Converter"
        description="Convert between US, EU, UK, and JP shoe sizes for men and women. Includes a complete size chart for reference."
        url="https://toolcase.cc/units/shoe-size-converter"
