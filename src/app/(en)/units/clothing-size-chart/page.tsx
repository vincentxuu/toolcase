...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/units/clothing-size-chart', languages: { en: 'https://toolcase.cc/units/clothing-size-chart', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/clothing-size-chart' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Clothing Size Chart', url: 'https://toolcase.cc/units/clothing-size-chart' },
        ]}
      />
      <ToolSchema
        name="Clothing Size Chart"
        description="International clothing size chart for men and women. Convert between TW, US, EU, UK, and JP sizes for tops and bottoms."
        url="https://toolcase.cc/units/clothing-size-chart"
