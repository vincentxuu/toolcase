...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/units/data-size-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Data Size Converter', url: 'https://toolcase.cc/units/data-size-converter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/units/data-size-converter"
