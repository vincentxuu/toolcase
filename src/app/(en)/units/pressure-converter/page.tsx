...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/units/pressure-converter', languages: { en: 'https://toolcase.cc/units/pressure-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/pressure-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Pressure Converter', url: 'https://toolcase.cc/units/pressure-converter' },
        ]}
      />
      <ToolSchema
        name="Pressure Converter"
        description="Convert between pressure units including Pascal, bar, PSI, atmosphere, Torr, mmHg, and more. Instant conversions with all common pressure units."
        url="https://toolcase.cc/units/pressure-converter"
