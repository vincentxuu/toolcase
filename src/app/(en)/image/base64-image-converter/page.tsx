...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/image/base64-image-converter', languages: { en: 'https://toolcase.cc/image/base64-image-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/base64-image-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Base64 Image Converter', url: 'https://toolcase.cc/image/base64-image-converter' },
        ]}
      />
      <ToolSchema
        name="Base64 Image Converter"
        description="Convert images to Base64 data URLs and decode Base64 back to images. Preview images, view dimensions and file size. Free browser-based tool."
        url="https://toolcase.cc/image/base64-image-converter"
