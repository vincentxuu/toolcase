...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/image/image-to-pdf',
    languages: {
      en: 'https://toolcase.cc/image/image-to-pdf',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/image-to-pdf',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Image to PDF', url: 'https://toolcase.cc/image/image-to-pdf' },
        ]}
      />
      <ToolSchema
        name="Image to PDF"
        description="Convert one or more images into a single PDF document for free. Supports PNG, JPEG, and WebP. Arrange pages, set orientation, and download instantly."
        url="https://toolcase.cc/image/image-to-pdf"
