...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/image/aspect-ratio-calculator', languages: { en: 'https://toolcase.cc/image/aspect-ratio-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/aspect-ratio-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Aspect Ratio Calculator', url: 'https://toolcase.cc/image/aspect-ratio-calculator' },
        ]}
      />
      <ToolSchema
        name="Aspect Ratio Calculator"
        description="Calculate and simplify aspect ratios instantly. Lock ratios, use presets like 16:9, 4:3, 1:1, and find the simplified ratio for any resolution."
        url="https://toolcase.cc/image/aspect-ratio-calculator"
