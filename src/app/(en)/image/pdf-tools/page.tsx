...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/image/pdf-tools',
    languages: {
      en: 'https://toolcase.cc/image/pdf-tools',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/pdf-tools',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'PDF Tools', url: 'https://toolcase.cc/image/pdf-tools' },
        ]}
      />
      <ToolSchema
        name="PDF Tools"
        ...
        url="https://toolcase.cc/image/pdf-tools"
