...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/days-counter', languages: { en: 'https://toolcase.cc/days-counter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/days-counter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Days Counter', url: 'https://toolcase.cc/days-counter' },
        ]}
      />
      <ToolSchema
        name="Days Counter"
        description="Count days, hours, minutes, and seconds until or since any date. Perfect for tracking birthdays, anniversaries, deadlines, and special events."
        url="https://toolcase.cc/days-counter"
