...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/gradient-generator', languages: { en: 'https://toolcase.cc/gradient-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/gradient-generator' } },
}
