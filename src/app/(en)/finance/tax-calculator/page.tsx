...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/finance/tax-calculator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Tax Calculator', url: 'https://toolcase.cc/finance/tax-calculator' },
        ]}
      />
      <ToolSchema
        name="Tax Calculator"
        ...
        url="https://toolcase.cc/finance/tax-calculator"
