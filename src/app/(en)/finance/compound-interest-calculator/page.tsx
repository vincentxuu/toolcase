...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/finance/compound-interest-calculator',
    languages: {
      en: 'https://toolcase.cc/finance/compound-interest-calculator',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/compound-interest-calculator',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Compound Interest Calculator', url: 'https://toolcase.cc/finance/compound-interest-calculator' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/finance/compound-interest-calculator"
