...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tw-securities-tax', languages: { en: 'https://toolcase.cc/finance/tw-securities-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-securities-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Securities Transaction Tax', url: 'https://toolcase.cc/finance/tw-securities-tax' },
        ]}
      />
      <ToolSchema
        name="Taiwan Securities Transaction Tax"
        description="Taiwan securities transaction tax rates for stocks, bonds, ETFs, and futures. Includes a quick calculator for transaction tax on sales."
        url="https://toolcase.cc/finance/tw-securities-tax"
