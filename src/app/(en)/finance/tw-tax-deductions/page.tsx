...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tw-tax-deductions', languages: { en: 'https://toolcase.cc/finance/tw-tax-deductions', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-tax-deductions' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Tax Deductions & Exemptions', url: 'https://toolcase.cc/finance/tw-tax-deductions' },
        ]}
      />
      <ToolSchema
        name="Taiwan Tax Deductions & Exemptions"
        description="Complete guide to Taiwan income tax exemptions, standard deductions, itemized deductions, special deductions, and basic living expense allowance for 2024."
        url="https://toolcase.cc/finance/tw-tax-deductions"
