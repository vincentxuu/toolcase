...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/finance/savings-calculator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Savings Calculator', url: 'https://toolcase.cc/finance/savings-calculator' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/finance/savings-calculator"
