...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/finance/credit-card-calculator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Credit Card Interest Calculator', url: 'https://toolcase.cc/finance/credit-card-calculator' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/finance/credit-card-calculator"
