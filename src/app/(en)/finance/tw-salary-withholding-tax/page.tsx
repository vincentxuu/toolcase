...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tw-salary-withholding-tax', languages: { en: 'https://toolcase.cc/finance/tw-salary-withholding-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-salary-withholding-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Salary Withholding Tax Table', url: 'https://toolcase.cc/finance/tw-salary-withholding-tax' },
        ]}
      />
      <ToolSchema
        name="Taiwan Salary Withholding Tax Table"
        description="Taiwan salary withholding tax table for residents and non-residents. Look up monthly withholding amounts by salary range for tax year 2025."
        url="https://toolcase.cc/finance/tw-salary-withholding-tax"
