...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/finance/retirement-calculator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Retirement Calculator', url: 'https://toolcase.cc/finance/retirement-calculator' },
        ]}
      />
      <ToolSchema
        name="Retirement Calculator"
        description="Plan your retirement with this free calculator. See projected savings, estimate retirement income, and visualize how long your money will last."
        url="https://toolcase.cc/finance/retirement-calculator"
