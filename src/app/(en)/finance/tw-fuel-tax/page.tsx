...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tw-fuel-tax', languages: { en: 'https://toolcase.cc/finance/tw-fuel-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-fuel-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Fuel Tax (Vehicle Fuel Fee)', url: 'https://toolcase.cc/finance/tw-fuel-tax' },
        ]}
      />
      <ToolSchema
        name="Taiwan Fuel Tax (Vehicle Fuel Fee)"
        description="Taiwan vehicle fuel usage fee schedule for cars and motorcycles by engine displacement. Includes both annual and quarterly payment amounts."
        url="https://toolcase.cc/finance/tw-fuel-tax"
