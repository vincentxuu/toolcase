...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tax-id-validator', languages: { en: 'https://toolcase.cc/finance/tax-id-validator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tax-id-validator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Tax ID Validator', url: 'https://toolcase.cc/finance/tax-id-validator' },
        ]}
      />
      <ToolSchema
        name="Taiwan Tax ID Validator"
        description="Validate Taiwan Business Tax ID (統一編號) using the official algorithm. Instantly check if an 8-digit tax ID is valid."
        url="https://toolcase.cc/finance/tax-id-validator"
