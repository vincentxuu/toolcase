...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/finance/loan-calculator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Loan Calculator', url: 'https://toolcase.cc/finance/loan-calculator' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/finance/loan-calculator"
