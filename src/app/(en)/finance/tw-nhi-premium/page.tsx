...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tw-nhi-premium', languages: { en: 'https://toolcase.cc/finance/tw-nhi-premium', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-nhi-premium' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan NHI Premium Table', url: 'https://toolcase.cc/finance/tw-nhi-premium' },
        ]}
      />
      <ToolSchema
        name="Taiwan NHI Premium Table"
        description="Taiwan National Health Insurance (NHI) premium table with salary grades, employee self-pay amounts, and employer contributions for 2024."
        url="https://toolcase.cc/finance/tw-nhi-premium"
