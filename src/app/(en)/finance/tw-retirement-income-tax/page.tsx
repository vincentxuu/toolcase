...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tw-retirement-income-tax', languages: { en: 'https://toolcase.cc/finance/tw-retirement-income-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-retirement-income-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Retirement Income Tax Exemption', url: 'https://toolcase.cc/finance/tw-retirement-income-tax' },
        ]}
      />
      <ToolSchema
        name="Taiwan Retirement Income Tax Exemption"
        description="Taiwan retirement income tax exemption rules for lump-sum and annuity payments. Includes tax-free thresholds by service years and a quick calculator."
        url="https://toolcase.cc/finance/tw-retirement-income-tax"
