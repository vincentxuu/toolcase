...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/finance/tw-labor-insurance', languages: { en: 'https://toolcase.cc/finance/tw-labor-insurance', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-labor-insurance' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Labor Insurance Premium Table', url: 'https://toolcase.cc/finance/tw-labor-insurance' },
        ]}
      />
      <ToolSchema
        name="Taiwan Labor Insurance Premium Table"
        description="Taiwan labor insurance premium table with salary grades, employee self-pay amounts, and employer contributions. Includes rate breakdown for 2024."
        url="https://toolcase.cc/finance/tw-labor-insurance"
