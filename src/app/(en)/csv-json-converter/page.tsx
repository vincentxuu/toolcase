...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/csv-json-converter',
    languages: {
      en: 'https://toolcase.cc/csv-json-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/csv-json-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSV ↔ JSON Converter', url: 'https://toolcase.cc/csv-json-converter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/csv-json-converter"
