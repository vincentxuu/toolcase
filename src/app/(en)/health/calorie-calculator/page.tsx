...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/health/calorie-calculator', languages: { en: 'https://toolcase.cc/health/calorie-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/calorie-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Calorie Calculator', url: 'https://toolcase.cc/health/calorie-calculator' },
        ]}
      />
      <ToolSchema
        name="Calorie Calculator"
        description="Calculate daily calorie needs based on your goals. Free online calorie calculator for weight loss, maintenance and muscle gain."
        url="https://toolcase.cc/health/calorie-calculator"
