...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/health/heart-rate-calculator', languages: { en: 'https://toolcase.cc/health/heart-rate-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/heart-rate-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Heart Rate Zone Calculator', url: 'https://toolcase.cc/health/heart-rate-calculator' },
        ]}
      />
      <ToolSchema
        name="Heart Rate Zone Calculator"
        description="Find your optimal heart rate training zones. Free online calculator for fat burn, cardio and peak heart rate zones."
        url="https://toolcase.cc/health/heart-rate-calculator"
