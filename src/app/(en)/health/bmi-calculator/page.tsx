...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/health/bmi-calculator', languages: { en: 'https://toolcase.cc/health/bmi-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/bmi-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'BMI Calculator', url: 'https://toolcase.cc/health/bmi-calculator' },
        ]}
      />
      <ToolSchema
        name="BMI Calculator"
        description="Calculate your Body Mass Index (BMI) instantly. Free online BMI calculator with visual scale and category breakdown."
        url="https://toolcase.cc/health/bmi-calculator"
