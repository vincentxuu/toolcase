...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/health/tdee-calculator', languages: { en: 'https://toolcase.cc/health/tdee-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/tdee-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'TDEE & BMR Calculator', url: 'https://toolcase.cc/health/tdee-calculator' },
        ]}
      />
      <ToolSchema
        name="TDEE & BMR Calculator"
        description="Calculate your Total Daily Energy Expenditure (TDEE) and Basal Metabolic Rate (BMR). Know exactly how many calories you need."
        url="https://toolcase.cc/health/tdee-calculator"
