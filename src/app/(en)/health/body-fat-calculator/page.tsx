...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/health/body-fat-calculator', languages: { en: 'https://toolcase.cc/health/body-fat-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/body-fat-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Body Fat Calculator', url: 'https://toolcase.cc/health/body-fat-calculator' },
        ]}
      />
      <ToolSchema
        name="Body Fat Calculator"
        description="Estimate body fat percentage using the US Navy method. Free online body fat calculator with instant results."
        url="https://toolcase.cc/health/body-fat-calculator"
