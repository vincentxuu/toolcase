...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/password-strength-checker', languages: { en: 'https://toolcase.cc/password-strength-checker', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/password-strength-checker' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Password Strength Checker', url: 'https://toolcase.cc/password-strength-checker' },
        ]}
      />
      <ToolSchema
        name="Password Strength Checker"
        description="Check your password strength instantly. Get detailed feedback on password security with requirements checklist. All checks happen in your browser."
        url="https://toolcase.cc/password-strength-checker"
