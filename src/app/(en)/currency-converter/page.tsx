...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/currency-converter', languages: { en: 'https://toolcase.cc/currency-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/currency-converter' } },
}
