...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/remove-duplicates', languages: { en: 'https://toolcase.cc/remove-duplicates', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/remove-duplicates' } },
}
