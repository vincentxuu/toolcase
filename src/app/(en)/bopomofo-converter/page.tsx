...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/bopomofo-converter', languages: { en: 'https://toolcase.cc/bopomofo-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/bopomofo-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Bopomofo Converter', url: 'https://toolcase.cc/bopomofo-converter' },
        ]}
      />
      <ToolSchema
        name="Bopomofo Converter"
        description="Convert Chinese characters to Bopomofo (Zhuyin) phonetic symbols. Learn Taiwan phonetic system with this converter tool."
        url="https://toolcase.cc/bopomofo-converter"
