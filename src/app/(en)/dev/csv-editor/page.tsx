...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/csv-editor', languages: { en: 'https://toolcase.cc/dev/csv-editor', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/csv-editor' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSV Editor', url: 'https://toolcase.cc/dev/csv-editor' },
        ]}
      />
      <ToolSchema
        name="CSV Editor"
        description="Edit CSV files in a visual spreadsheet interface. Add, delete, modify rows and columns. Support multiple delimiters. Download edited CSV. Free browser tool."
        url="https://toolcase.cc/dev/csv-editor"
