...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/test-card-generator', languages: { en: 'https://toolcase.cc/dev/test-card-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/test-card-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Test Card Generator', url: 'https://toolcase.cc/dev/test-card-generator' },
        ]}
      />
      <ToolSchema
        name="Test Card Generator"
        description="Generate valid test credit card numbers for development and testing. Supports Visa, MasterCard, Amex, Discover, JCB, and Diners Club."
        url="https://toolcase.cc/dev/test-card-generator"
