...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/markdown-to-html', languages: { en: 'https://toolcase.cc/dev/markdown-to-html', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/markdown-to-html' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Markdown to HTML Converter', url: 'https://toolcase.cc/dev/markdown-to-html' },
        ]}
      />
      <ToolSchema
        name="Markdown to HTML Converter"
        description="Convert Markdown text to clean HTML source code. Free online Markdown to HTML converter for developers and content creators."
        url="https://toolcase.cc/dev/markdown-to-html"
