...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/regex-tester', languages: { en: 'https://toolcase.cc/dev/regex-tester', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/regex-tester' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Regex Tester', url: 'https://toolcase.cc/dev/regex-tester' },
        ]}
      />
      <ToolSchema
        name="Regex Tester"
        description="Test and debug regular expressions with real-time highlighting. Free online regex tester and debugger."
        url="https://toolcase.cc/dev/regex-tester"
