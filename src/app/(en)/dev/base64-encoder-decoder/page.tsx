...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/base64-encoder-decoder', languages: { en: 'https://toolcase.cc/dev/base64-encoder-decoder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/base64-encoder-decoder' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Base64 Encoder/Decoder', url: 'https://toolcase.cc/dev/base64-encoder-decoder' },
        ]}
      />
      <ToolSchema
        name="Base64 Encoder/Decoder"
        description="Encode and decode Base64 strings instantly. Free online Base64 tool for developers and data processing."
        url="https://toolcase.cc/dev/base64-encoder-decoder"
