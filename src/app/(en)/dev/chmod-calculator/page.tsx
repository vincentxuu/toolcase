...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/chmod-calculator', languages: { en: 'https://toolcase.cc/dev/chmod-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/chmod-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Chmod Calculator', url: 'https://toolcase.cc/dev/chmod-calculator' },
        ]}
      />
      <ToolSchema
        name="Chmod Calculator"
        description="Calculate Unix file permissions with an interactive chmod calculator. Toggle read, write, and execute for owner, group, and others to get numeric and symbolic notation."
        url="https://toolcase.cc/dev/chmod-calculator"
