...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/slug-generator', languages: { en: 'https://toolcase.cc/dev/slug-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/slug-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Slug Generator', url: 'https://toolcase.cc/dev/slug-generator' },
        ]}
      />
      <ToolSchema
        name="Slug Generator"
        description="Convert text to URL-friendly slugs. Free online slug generator with customizable separator, case, and length options."
        url="https://toolcase.cc/dev/slug-generator"
