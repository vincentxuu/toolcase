...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/hash-generator', languages: { en: 'https://toolcase.cc/dev/hash-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/hash-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Hash Generator', url: 'https://toolcase.cc/dev/hash-generator' },
        ]}
      />
      <ToolSchema
        name="Hash Generator"
        description="Generate MD5, SHA-1, SHA-256 and other hash values from text. Free online hash generator for developers."
        url="https://toolcase.cc/dev/hash-generator"
