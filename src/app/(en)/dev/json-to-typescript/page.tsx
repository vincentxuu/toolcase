...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/json-to-typescript',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JSON to TypeScript', url: 'https://toolcase.cc/dev/json-to-typescript' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/json-to-typescript"
