...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/ip-subnet-calculator', languages: { en: 'https://toolcase.cc/dev/ip-subnet-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/ip-subnet-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'IP Subnet Calculator', url: 'https://toolcase.cc/dev/ip-subnet-calculator' },
        ]}
      />
      <ToolSchema
        name="IP Subnet Calculator"
        description="Calculate IP subnet details including network address, broadcast address, subnet mask, host range, and total usable hosts from any IP and CIDR notation."
        url="https://toolcase.cc/dev/ip-subnet-calculator"
