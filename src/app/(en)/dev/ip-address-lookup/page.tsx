...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/ip-address-lookup',
    languages: {
      en: 'https://toolcase.cc/dev/ip-address-lookup',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/ip-address-lookup',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'IP Address Lookup', url: 'https://toolcase.cc/dev/ip-address-lookup' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/ip-address-lookup"
