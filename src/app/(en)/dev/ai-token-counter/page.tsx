...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/ai-token-counter', languages: { en: 'https://toolcase.cc/dev/ai-token-counter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/ai-token-counter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'AI Token Counter & Cost Calculator', url: 'https://toolcase.cc/dev/ai-token-counter' },
        ]}
      />
      <ToolSchema
        name="AI Token Counter & Cost Calculator"
        description="Count tokens and estimate API costs for GPT-4o, Claude, Gemini and more. Free online AI token counter with cost calculator for all major LLM models."
        url="https://toolcase.cc/dev/ai-token-counter"
