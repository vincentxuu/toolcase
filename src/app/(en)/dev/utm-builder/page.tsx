...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/utm-builder',
    languages: {
      en: 'https://toolcase.cc/dev/utm-builder',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/utm-builder',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'UTM Builder', url: 'https://toolcase.cc/dev/utm-builder' },
        ]}
      />
      <ToolSchema
        name="UTM Builder"
        ...
        url="https://toolcase.cc/dev/utm-builder"
