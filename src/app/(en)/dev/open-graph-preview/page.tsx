...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/open-graph-preview',
    languages: {
      en: 'https://toolcase.cc/dev/open-graph-preview',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/open-graph-preview',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Open Graph Preview', url: 'https://toolcase.cc/dev/open-graph-preview' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/open-graph-preview"
