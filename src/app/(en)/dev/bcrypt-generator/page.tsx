...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/bcrypt-generator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Password Hash Generator', url: 'https://toolcase.cc/dev/bcrypt-generator' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/bcrypt-generator"
