...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/http-status-codes', languages: { en: 'https://toolcase.cc/dev/http-status-codes', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/http-status-codes' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTTP Status Code Reference', url: 'https://toolcase.cc/dev/http-status-codes' },
        ]}
      />
      <ToolSchema
        name="HTTP Status Code Reference"
        description="Complete HTTP status code reference with descriptions. Search and filter all status codes from 1xx to 5xx. A quick reference for web developers."
        url="https://toolcase.cc/dev/http-status-codes"
