...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/html-entity-encoder', languages: { en: 'https://toolcase.cc/dev/html-entity-encoder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/html-entity-encoder' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTML Entity Encoder/Decoder', url: 'https://toolcase.cc/dev/html-entity-encoder' },
        ]}
      />
      <ToolSchema
        name="HTML Entity Encoder/Decoder"
        description="Encode and decode HTML entities online. Convert special characters to HTML entities and back. Supports named and numeric entities."
        url="https://toolcase.cc/dev/html-entity-encoder"
