...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/json-formatter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JSON Formatter & Validator', url: 'https://toolcase.cc/dev/json-formatter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/json-formatter"
