...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/unicode-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Unicode Converter', url: 'https://toolcase.cc/dev/unicode-converter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/unicode-converter"
