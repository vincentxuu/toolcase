...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/rsa-key-generator',
    languages: {
      en: 'https://toolcase.cc/dev/rsa-key-generator',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/rsa-key-generator',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'RSA Key Pair Generator', url: 'https://toolcase.cc/dev/rsa-key-generator' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/rsa-key-generator"
