...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/integer-base-converter', languages: { en: 'https://toolcase.cc/dev/integer-base-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/integer-base-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Integer Base Converter', url: 'https://toolcase.cc/dev/integer-base-converter' },
        ]}
      />
      <ToolSchema
        name="Integer Base Converter"
        description="Convert numbers between binary, octal, decimal, hexadecimal and custom bases. Free online base converter for developers."
        url="https://toolcase.cc/dev/integer-base-converter"
