...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/json-diff', languages: { en: 'https://toolcase.cc/dev/json-diff', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/json-diff' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JSON Diff Comparator', url: 'https://toolcase.cc/dev/json-diff' },
        ]}
      />
      <ToolSchema
        name="JSON Diff Comparator"
        description="Compare two JSON objects and visualize differences with syntax highlighting. Supports unified and split view, JSON and text mode comparison. Free browser tool."
        url="https://toolcase.cc/dev/json-diff"
