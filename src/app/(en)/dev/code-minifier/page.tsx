...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/code-minifier',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTML/CSS/JS Minifier', url: 'https://toolcase.cc/dev/code-minifier' },
        ]}
      />
      <ToolSchema
        name="HTML/CSS/JS Minifier"
        description="Minify HTML, CSS, and JavaScript code instantly. Remove comments, whitespace, and unnecessary characters to reduce file size."
        url="https://toolcase.cc/dev/code-minifier"
