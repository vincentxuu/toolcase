...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/json-path-finder', languages: { en: 'https://toolcase.cc/dev/json-path-finder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/json-path-finder' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JSON Path Finder', url: 'https://toolcase.cc/dev/json-path-finder' },
        ]}
      />
      <ToolSchema
        name="JSON Path Finder"
        description="Paste JSON and explore its structure in a tree view. Click any node to get its JSON path in dot or bracket notation. Copy paths to clipboard instantly."
        url="https://toolcase.cc/dev/json-path-finder"
