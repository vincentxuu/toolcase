...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/text-encrypt-decrypt',
    languages: {
      en: 'https://toolcase.cc/dev/text-encrypt-decrypt',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/text-encrypt-decrypt',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Text Encrypt / Decrypt', url: 'https://toolcase.cc/dev/text-encrypt-decrypt' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/text-encrypt-decrypt"
