...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/dev/uuid-generator', languages: { en: 'https://toolcase.cc/dev/uuid-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/uuid-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'UUID Generator', url: 'https://toolcase.cc/dev/uuid-generator' },
        ]}
      />
      <ToolSchema
        name="UUID Generator"
        description="Generate UUID v4 and ULID identifiers instantly. Free online UUID generator with bulk generation support for developers."
        url="https://toolcase.cc/dev/uuid-generator"
