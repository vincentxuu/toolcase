...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/meta-tag-generator',
    languages: {
      en: 'https://toolcase.cc/dev/meta-tag-generator',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/meta-tag-generator',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Meta Tag Generator', url: 'https://toolcase.cc/dev/meta-tag-generator' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/meta-tag-generator"
