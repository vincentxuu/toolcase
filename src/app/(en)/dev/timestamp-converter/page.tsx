...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/dev/timestamp-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Timestamp Converter', url: 'https://toolcase.cc/dev/timestamp-converter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/dev/timestamp-converter"
