...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/stopwatch', languages: { en: 'https://toolcase.cc/everyday/stopwatch', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/stopwatch' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Stopwatch', url: 'https://toolcase.cc/everyday/stopwatch' },
        ]}
      />
      <ToolSchema
        name="Stopwatch"
        description="Free online stopwatch with lap timing. Accurate stopwatch for sports, workouts, cooking and productivity."
        url="https://toolcase.cc/everyday/stopwatch"
