...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/percentage-calculator', languages: { en: 'https://toolcase.cc/everyday/percentage-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/percentage-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Percentage Calculator', url: 'https://toolcase.cc/everyday/percentage-calculator' },
        ]}
      />
      <ToolSchema
        name="Percentage Calculator"
        description="Calculate percentages instantly. Find what percent of a number, percentage change, and more."
        url="https://toolcase.cc/everyday/percentage-calculator"
