...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/gpa-calculator', languages: { en: 'https://toolcase.cc/everyday/gpa-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/gpa-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'GPA Calculator', url: 'https://toolcase.cc/everyday/gpa-calculator' },
        ]}
      />
      <ToolSchema
        name="GPA Calculator"
        description="Calculate your cumulative GPA instantly. Add courses with grades and credits to see your grade point average."
        url="https://toolcase.cc/everyday/gpa-calculator"
