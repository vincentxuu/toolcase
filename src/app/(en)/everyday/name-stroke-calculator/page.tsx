...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/name-stroke-calculator', languages: { en: 'https://toolcase.cc/everyday/name-stroke-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/name-stroke-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Chinese Name Stroke Calculator', url: 'https://toolcase.cc/everyday/name-stroke-calculator' },
        ]}
      />
      <ToolSchema
        name="Chinese Name Stroke Calculator"
        description="Calculate the total stroke count of Chinese characters in a name and check fortune based on traditional numerology."
        url="https://toolcase.cc/everyday/name-stroke-calculator"
