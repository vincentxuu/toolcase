...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/discount-calculator', languages: { en: 'https://toolcase.cc/everyday/discount-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/discount-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Discount Calculator', url: 'https://toolcase.cc/everyday/discount-calculator' },
        ]}
      />
      <ToolSchema
        name="Discount Calculator"
        description="Calculate sale prices, savings and discount percentages instantly."
        url="https://toolcase.cc/everyday/discount-calculator"
