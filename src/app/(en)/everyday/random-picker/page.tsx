...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/random-picker', languages: { en: 'https://toolcase.cc/everyday/random-picker', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/random-picker' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Random Picker', url: 'https://toolcase.cc/everyday/random-picker' },
        ]}
      />
      <ToolSchema
        name="Random Picker"
        description="Randomly pick items from a list. Free online random picker for decisions, raffles, team selection and more."
        url="https://toolcase.cc/everyday/random-picker"
