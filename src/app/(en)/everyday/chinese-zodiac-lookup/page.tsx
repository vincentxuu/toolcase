...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/chinese-zodiac-lookup', languages: { en: 'https://toolcase.cc/everyday/chinese-zodiac-lookup', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/chinese-zodiac-lookup' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Chinese Zodiac Lookup', url: 'https://toolcase.cc/everyday/chinese-zodiac-lookup' },
        ]}
      />
      <ToolSchema
        name="Chinese Zodiac Lookup"
        description="Enter your birth year to find your Chinese zodiac animal sign! Complete reference with all 12 animals, five elements, personality traits, and compatibility."
        url="https://toolcase.cc/everyday/chinese-zodiac-lookup"
