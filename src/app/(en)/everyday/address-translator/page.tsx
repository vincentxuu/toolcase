...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/address-translator', languages: { en: 'https://toolcase.cc/everyday/address-translator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/address-translator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan Address Translator', url: 'https://toolcase.cc/everyday/address-translator' },
        ]}
      />
      <ToolSchema
        name="Taiwan Address Translator"
        description="Translate Taiwan Chinese addresses to English format. Auto-detects cities and districts for international mail and forms."
        url="https://toolcase.cc/everyday/address-translator"
