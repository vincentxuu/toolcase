...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/wifi-qr-generator', languages: { en: 'https://toolcase.cc/everyday/wifi-qr-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/wifi-qr-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'WiFi QR Code Generator', url: 'https://toolcase.cc/everyday/wifi-qr-generator' },
        ]}
      />
      <ToolSchema
        name="WiFi QR Code Generator"
        description="Generate a QR code for your WiFi network. Guests can scan the code to connect instantly without typing the password. Supports WPA, WEP, and open networks."
        url="https://toolcase.cc/everyday/wifi-qr-generator"
