...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/taiwan-id-validator', languages: { en: 'https://toolcase.cc/everyday/taiwan-id-validator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/taiwan-id-validator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Taiwan ID Validator', url: 'https://toolcase.cc/everyday/taiwan-id-validator' },
        ]}
      />
      <ToolSchema
        name="Taiwan ID Validator"
        description="Validate Taiwan business IDs (統一編號) and national identification numbers (身分證字號) online. Free format checker with random ID generator for testing."
        url="https://toolcase.cc/everyday/taiwan-id-validator"
