...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/relative-title-calculator', languages: { en: 'https://toolcase.cc/everyday/relative-title-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/relative-title-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Relative Title Calculator', url: 'https://toolcase.cc/everyday/relative-title-calculator' },
        ]}
      />
      <ToolSchema
        name="Relative Title Calculator"
        description="Calculate Taiwan family relationship titles. Learn how to address relatives in Chinese family structure with this interactive tool."
        url="https://toolcase.cc/everyday/relative-title-calculator"
