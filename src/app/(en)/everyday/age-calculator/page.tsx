...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/age-calculator', languages: { en: 'https://toolcase.cc/everyday/age-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/age-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Age Calculator', url: 'https://toolcase.cc/everyday/age-calculator' },
        ]}
      />
      <ToolSchema
        name="Age Calculator"
        description="Calculate your exact age in years, months, days, and more. Find days until your next birthday."
        url="https://toolcase.cc/everyday/age-calculator"
