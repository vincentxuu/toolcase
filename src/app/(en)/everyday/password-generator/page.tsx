...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/password-generator', languages: { en: 'https://toolcase.cc/everyday/password-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/password-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Password Generator', url: 'https://toolcase.cc/everyday/password-generator' },
        ]}
      />
      <ToolSchema
        name="Password Generator"
        description="Generate strong, random passwords instantly. Customize length and character types. All generation happens in your browser."
        url="https://toolcase.cc/everyday/password-generator"
