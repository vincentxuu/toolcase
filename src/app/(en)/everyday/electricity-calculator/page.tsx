...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/electricity-calculator', languages: { en: 'https://toolcase.cc/everyday/electricity-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/electricity-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Electricity Cost Calculator', url: 'https://toolcase.cc/everyday/electricity-calculator' },
        ]}
      />
      <ToolSchema
        name="Electricity Cost Calculator"
        description="Calculate electricity costs for your devices. Enter wattage, usage hours, and rate to see daily, monthly, and yearly costs."
        url="https://toolcase.cc/everyday/electricity-calculator"
