...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/tip-calculator', languages: { en: 'https://toolcase.cc/everyday/tip-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/tip-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Tip Calculator', url: 'https://toolcase.cc/everyday/tip-calculator' },
        ]}
      />
      <ToolSchema
        name="Tip Calculator"
        description="Calculate tips and split bills between friends easily. Free online tip calculator for restaurants, bars and services."
        url="https://toolcase.cc/everyday/tip-calculator"
