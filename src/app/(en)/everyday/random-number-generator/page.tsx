...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/random-number-generator', languages: { en: 'https://toolcase.cc/everyday/random-number-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/random-number-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Random Number Generator', url: 'https://toolcase.cc/everyday/random-number-generator' },
        ]}
      />
      <ToolSchema
        name="Random Number Generator"
        description="Generate random numbers within any range. Free online random number generator for games, lotteries, statistics and more."
        url="https://toolcase.cc/everyday/random-number-generator"
