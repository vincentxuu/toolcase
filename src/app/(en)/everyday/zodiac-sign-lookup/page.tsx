...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/zodiac-sign-lookup', languages: { en: 'https://toolcase.cc/everyday/zodiac-sign-lookup', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/zodiac-sign-lookup' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Zodiac Sign Lookup', url: 'https://toolcase.cc/everyday/zodiac-sign-lookup' },
        ]}
      />
      <ToolSchema
        name="Zodiac Sign Lookup"
        description="Enter your birthday to find your zodiac sign instantly! Complete reference table with all 12 zodiac signs, date ranges, elements, and personality traits."
        url="https://toolcase.cc/everyday/zodiac-sign-lookup"
