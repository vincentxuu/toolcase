...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/world-clock', languages: { en: 'https://toolcase.cc/everyday/world-clock', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/world-clock' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'World Clock', url: 'https://toolcase.cc/everyday/world-clock' },
        ]}
      />
      <ToolSchema
        name="World Clock"
        description="Check the current time in major cities worldwide. See live time updates for different timezones around the globe."
        url="https://toolcase.cc/everyday/world-clock"
