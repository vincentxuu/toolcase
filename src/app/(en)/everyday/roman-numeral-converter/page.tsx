...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/roman-numeral-converter', languages: { en: 'https://toolcase.cc/everyday/roman-numeral-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/roman-numeral-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Roman Numeral Converter', url: 'https://toolcase.cc/everyday/roman-numeral-converter' },
        ]}
      />
      <ToolSchema
        name="Roman Numeral Converter"
        description="Convert between decimal numbers and Roman numerals instantly. Supports values from 1 to 3999 with a full conversion reference table."
        url="https://toolcase.cc/everyday/roman-numeral-converter"
