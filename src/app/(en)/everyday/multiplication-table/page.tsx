...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/multiplication-table', languages: { en: 'https://toolcase.cc/everyday/multiplication-table', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/multiplication-table' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Multiplication Table', url: 'https://toolcase.cc/everyday/multiplication-table' },
        ]}
      />
      <ToolSchema
        name="Multiplication Table"
        description="Interactive multiplication table up to 19×19. Click any cell to copy the equation. Great for students and teachers."
        url="https://toolcase.cc/everyday/multiplication-table"
