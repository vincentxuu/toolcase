...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/everyday/countdown-timer', languages: { en: 'https://toolcase.cc/everyday/countdown-timer', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/countdown-timer' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Countdown Timer', url: 'https://toolcase.cc/everyday/countdown-timer' },
        ]}
      />
      <ToolSchema
        name="Countdown Timer"
        description="Set a countdown timer with alarm. Free online countdown timer for cooking, studying, workouts and more."
        url="https://toolcase.cc/everyday/countdown-timer"
