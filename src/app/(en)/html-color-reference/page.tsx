...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/html-color-reference', languages: { en: 'https://toolcase.cc/html-color-reference', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/html-color-reference' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTML Color Reference', url: 'https://toolcase.cc/html-color-reference' },
        ]}
      />
      <ToolSchema
        name="HTML Color Reference"
        description="Browse all 140+ HTML named colors with hex codes. Searchable color reference chart for web development and design."
        url="https://toolcase.cc/html-color-reference"
