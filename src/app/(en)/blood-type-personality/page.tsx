...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/blood-type-personality', languages: { en: 'https://toolcase.cc/blood-type-personality', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/blood-type-personality' } },
}
