...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/yaml-json-converter',
    languages: {
      en: 'https://toolcase.cc/yaml-json-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/yaml-json-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'YAML ↔ JSON Converter', url: 'https://toolcase.cc/yaml-json-converter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/yaml-json-converter"
