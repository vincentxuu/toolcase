...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/social-video-speed', languages: { en: 'https://toolcase.cc/social-video-speed', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/social-video-speed' } },
}
