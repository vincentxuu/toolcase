...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/due-date-calculator', languages: { en: 'https://toolcase.cc/due-date-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/due-date-calculator' } },
}
