...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/credit-card-validator', languages: { en: 'https://toolcase.cc/credit-card-validator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/credit-card-validator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Credit Card Validator', url: 'https://toolcase.cc/credit-card-validator' },
        ]}
      />
      <ToolSchema
        name="Credit Card Validator"
        description="Validate credit card numbers using the Luhn algorithm. Detects card type (Visa, MasterCard, Amex, etc.). All validation happens in your browser."
        url="https://toolcase.cc/credit-card-validator"
