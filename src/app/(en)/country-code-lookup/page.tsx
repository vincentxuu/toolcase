...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/country-code-lookup', languages: { en: 'https://toolcase.cc/country-code-lookup', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/country-code-lookup' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Country Code Lookup', url: 'https://toolcase.cc/country-code-lookup' },
        ]}
      />
      <ToolSchema
        name="Country Code Lookup"
        description="Find international dialing codes for any country. Quick search for country calling codes with flags and country names."
        url="https://toolcase.cc/country-code-lookup"
