...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css/color-blindness-simulator', languages: { en: 'https://toolcase.cc/css/color-blindness-simulator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/color-blindness-simulator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Color Blindness Simulator', url: 'https://toolcase.cc/css/color-blindness-simulator' },
        ]}
      />
      <ToolSchema
        name="Color Blindness Simulator"
        description="Simulate how colors appear to people with color vision deficiencies. Preview protanopia, deuteranopia, tritanopia, and more color blindness types instantly."
        url="https://toolcase.cc/css/color-blindness-simulator"
