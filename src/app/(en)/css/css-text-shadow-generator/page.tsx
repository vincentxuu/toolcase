...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css/css-text-shadow-generator', languages: { en: 'https://toolcase.cc/css/css-text-shadow-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/css-text-shadow-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSS Text Shadow Generator', url: 'https://toolcase.cc/css/css-text-shadow-generator' },
        ]}
      />
      <ToolSchema
        name="CSS Text Shadow Generator"
        description="Generate CSS text-shadow with visual controls. Adjust offset, blur, color and opacity. Support for multiple shadow layers with live preview and copy CSS."
        url="https://toolcase.cc/css/css-text-shadow-generator"
