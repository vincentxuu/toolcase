...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css/css-clip-path-generator', languages: { en: 'https://toolcase.cc/css/css-clip-path-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/css-clip-path-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSS Clip Path Generator', url: 'https://toolcase.cc/css/css-clip-path-generator' },
        ]}
      />
      <ToolSchema
        name="CSS Clip Path Generator"
        description="Generate CSS clip-path shapes visually. Choose from circle, ellipse, triangle, polygon, pentagon, hexagon, and star presets with live preview."
        url="https://toolcase.cc/css/css-clip-path-generator"
