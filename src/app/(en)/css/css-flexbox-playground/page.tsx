...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css/css-flexbox-playground', languages: { en: 'https://toolcase.cc/css/css-flexbox-playground', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/css-flexbox-playground' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSS Flexbox Playground', url: 'https://toolcase.cc/css/css-flexbox-playground' },
        ]}
      />
      <ToolSchema
        name="CSS Flexbox Playground"
        description="Interactive CSS Flexbox playground. Adjust flex-direction, justify-content, align-items, flex-wrap and gap with live visual preview."
        url="https://toolcase.cc/css/css-flexbox-playground"
