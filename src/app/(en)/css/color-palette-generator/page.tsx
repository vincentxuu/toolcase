...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css/color-palette-generator', languages: { en: 'https://toolcase.cc/css/color-palette-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/color-palette-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Color Palette Generator', url: 'https://toolcase.cc/css/color-palette-generator' },
        ]}
      />
      <ToolSchema
        name="Color Palette Generator"
        description="Generate harmonious color palettes from any base color. Complementary, analogous, triadic, split-complementary and monochromatic schemes with one click."
        url="https://toolcase.cc/css/color-palette-generator"
