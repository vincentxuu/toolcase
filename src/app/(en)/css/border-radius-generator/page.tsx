...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css/border-radius-generator', languages: { en: 'https://toolcase.cc/css/border-radius-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/border-radius-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Border Radius Generator', url: 'https://toolcase.cc/css/border-radius-generator' },
        ]}
      />
      <ToolSchema
        name="Border Radius Generator"
        description="Generate CSS border-radius with visual controls for each corner. Link or unlink corners, preview the shape, and copy the CSS code."
        url="https://toolcase.cc/css/border-radius-generator"
