...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css/box-shadow-generator', languages: { en: 'https://toolcase.cc/css/box-shadow-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/box-shadow-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Box Shadow Generator', url: 'https://toolcase.cc/css/box-shadow-generator' },
        ]}
      />
      <ToolSchema
        name="Box Shadow Generator"
        description="Generate CSS box-shadow with visual controls. Adjust offset, blur, spread, color and opacity. Support for multiple shadows and inset mode."
        url="https://toolcase.cc/css/box-shadow-generator"
