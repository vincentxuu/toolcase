...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/css-grid-generator', languages: { en: 'https://toolcase.cc/css-grid-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css-grid-generator' } },
}
