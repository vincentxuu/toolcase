...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/text/social-media-counter',
    languages: {
      en: 'https://toolcase.cc/text/social-media-counter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/social-media-counter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Social Media Character Counter', url: 'https://toolcase.cc/text/social-media-counter' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/text/social-media-counter"
