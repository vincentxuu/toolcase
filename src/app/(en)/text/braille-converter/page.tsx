...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/text/braille-converter', languages: { en: 'https://toolcase.cc/text/braille-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/braille-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Braille Converter', url: 'https://toolcase.cc/text/braille-converter' },
        ]}
      />
      <ToolSchema
        name="Braille Converter"
        description="Convert text to Braille and Braille to text. Learn and practice Braille reading with this online converter tool."
        url="https://toolcase.cc/text/braille-converter"
