...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/text/text-repeater', languages: { en: 'https://toolcase.cc/text/text-repeater', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/text-repeater' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Text Repeater', url: 'https://toolcase.cc/text/text-repeater' },
        ]}
      />
      <ToolSchema
        name="Text Repeater"
        description="Repeat any text multiple times with custom separators. Choose newline, space, comma, or custom separator. Generate repeated text up to 10,000 times instantly."
        url="https://toolcase.cc/text/text-repeater"
