...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/text/text-to-handwriting',
    languages: {
      en: 'https://toolcase.cc/text/text-to-handwriting',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/text-to-handwriting',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Text to Handwriting', url: 'https://toolcase.cc/text/text-to-handwriting' },
        ]}
      />
      <ToolSchema
        ...
        url="https://toolcase.cc/text/text-to-handwriting"
