...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/text/pinyin-converter', languages: { en: 'https://toolcase.cc/text/pinyin-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/pinyin-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Pinyin Converter', url: 'https://toolcase.cc/text/pinyin-converter' },
        ]}
      />
      <ToolSchema
        name="Pinyin Converter"
        description="Convert Chinese characters to Pinyin with tone marks. Supports multiple output formats including tones, numbers, and first letters."
        url="https://toolcase.cc/text/pinyin-converter"
