...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/text/case-converter', languages: { en: 'https://toolcase.cc/text/case-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/case-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Case Converter', url: 'https://toolcase.cc/text/case-converter' },
        ]}
      />
      <ToolSchema
        name="Case Converter"
        description="Convert text between uppercase, lowercase, title case, camelCase, snake_case and more. Free online case converter tool."
        url="https://toolcase.cc/text/case-converter"
