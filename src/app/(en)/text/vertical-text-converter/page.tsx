...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/text/vertical-text-converter', languages: { en: 'https://toolcase.cc/text/vertical-text-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/vertical-text-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Vertical Text Converter', url: 'https://toolcase.cc/text/vertical-text-converter' },
        ]}
      />
      <ToolSchema
        name="Vertical Text Converter"
        description="Convert text to vertical writing format. Preview traditional vertical text layout used in Chinese, Japanese, and Korean typography."
        url="https://toolcase.cc/text/vertical-text-converter"
