...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/text/text-to-speech',
    languages: {
      en: 'https://toolcase.cc/text/text-to-speech',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/text-to-speech',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Text to Speech', url: 'https://toolcase.cc/text/text-to-speech' },
        ]}
      />
      <ToolSchema
        name="Text to Speech"
        description="Convert text to natural-sounding speech using your browser\"
        url="https://toolcase.cc/text/text-to-speech"
