...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/text/word-counter', languages: { en: 'https://toolcase.cc/text/word-counter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/word-counter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Word Counter', url: 'https://toolcase.cc/text/word-counter' },
        ]}
      />
      <ToolSchema
        name="Word Counter"
        description="Count words, characters, sentences and paragraphs instantly. Free online word counter for writers, students and professionals."
        url="https://toolcase.cc/text/word-counter"
