...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/text/fancy-text-generator', languages: { en: 'https://toolcase.cc/text/fancy-text-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/fancy-text-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Fancy Text Generator', url: 'https://toolcase.cc/text/fancy-text-generator' },
        ]}
      />
      <ToolSchema
        name="Fancy Text Generator"
        description="Generate fancy text with bold, italic, script, fraktur, double-struck, monospace, circled, fullwidth, upside down and small caps Unicode styles. Copy and paste anywhere."
        url="https://toolcase.cc/text/fancy-text-generator"
