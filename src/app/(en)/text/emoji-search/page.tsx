...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/text/emoji-search',
    languages: {
      en: 'https://toolcase.cc/text/emoji-search',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/emoji-search',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Emoji Search', url: 'https://toolcase.cc/text/emoji-search' },
        ]}
      />
      <ToolSchema
        name="Emoji Search"
        ...
        url="https://toolcase.cc/text/emoji-search"
