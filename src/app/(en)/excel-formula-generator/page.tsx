...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/excel-formula-generator', languages: { en: 'https://toolcase.cc/excel-formula-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/excel-formula-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Excel Formula Generator', url: 'https://toolcase.cc/excel-formula-generator' },
        ]}
      />
      <ToolSchema
        name="Excel Formula Generator"
        description="Browse and copy common Excel formulas with syntax and examples. Includes math, statistical, logical, text, date, lookup, and financial functions. Free reference tool."
        url="https://toolcase.cc/excel-formula-generator"
