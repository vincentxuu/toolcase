...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/tw-vehicle-license-tax', languages: { en: 'https://toolcase.cc/tw-vehicle-license-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/tw-vehicle-license-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '使用牌照稅', url: 'https://toolcase.cc/zh-tw/tw-vehicle-license-tax' },
        ]}
      />
      <ToolSchema
        name="使用牌照稅"
        description="使用牌照稅稅額對照表，含汽車（自用/營業用）、機車、電動車年度稅額，依排氣量或馬力分級。"
        url="https://toolcase.cc/zh-tw/tw-vehicle-license-tax"
