...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/pinyin-converter', languages: { en: 'https://toolcase.cc/pinyin-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/pinyin-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '拼音轉換', url: 'https://toolcase.cc/zh-tw/pinyin-converter' },
        ]}
      />
      <ToolSchema
        name="拼音轉換"
        description="將中文字轉換為帶聲調的拼音。支援多種輸出格式，包括聲調符號、數字標記和首字母。"
        url="https://toolcase.cc/zh-tw/pinyin-converter"
