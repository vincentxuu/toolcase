...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/country-code-lookup', languages: { en: 'https://toolcase.cc/country-code-lookup', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/country-code-lookup' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '國際電話區碼', url: 'https://toolcase.cc/zh-tw/country-code-lookup' },
        ]}
      />
      <ToolSchema
        name="國際電話區碼"
        description="查詢任何國家的國際撥號代碼。快速搜尋國家電話區號，包含國旗和國家名稱。"
        url="https://toolcase.cc/zh-tw/country-code-lookup"
