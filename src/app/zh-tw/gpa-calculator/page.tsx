...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/gpa-calculator', languages: { en: 'https://toolcase.cc/gpa-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/gpa-calculator' } },
}
