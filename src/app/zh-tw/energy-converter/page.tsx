...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/energy-converter', languages: { en: 'https://toolcase.cc/energy-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/energy-converter' } },
}
