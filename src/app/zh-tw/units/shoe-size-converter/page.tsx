...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/units/shoe-size-converter', languages: { en: 'https://toolcase.cc/units/shoe-size-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/shoe-size-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '鞋碼轉換器', url: 'https://toolcase.cc/zh-tw/units/shoe-size-converter' },
        ]}
      />
      <ToolSchema
        name="鞋碼轉換器"
        description="在美規、歐規、英規和日規鞋碼之間轉換。附完整尺碼對照表供參考。"
        url="https://toolcase.cc/zh-tw/units/shoe-size-converter"
