...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/units/length-converter',
    languages: {
      en: 'https://toolcase.cc/units/length-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/length-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '長度轉換器', url: 'https://toolcase.cc/zh-tw/units/length-converter' },
        ]}
      />
      <ToolSchema
        name="長度轉換器"
        description="在公尺、公里、英里、英尺、英寸等單位之間輕鬆轉換。免費線上長度轉換器，即時顯示結果。"
        url="https://toolcase.cc/zh-tw/units/length-converter"
