...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/units/temperature-converter',
    languages: {
      en: 'https://toolcase.cc/units/temperature-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/temperature-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '溫度轉換器', url: 'https://toolcase.cc/zh-tw/units/temperature-converter' },
        ]}
      />
      <ToolSchema
        name="溫度轉換器"
        description="在攝氏、華氏和克氏溫度之間輕鬆轉換。免費線上溫度轉換器，即時顯示結果。"
        url="https://toolcase.cc/zh-tw/units/temperature-converter"
