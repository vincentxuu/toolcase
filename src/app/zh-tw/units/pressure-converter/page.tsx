...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/units/pressure-converter', languages: { en: 'https://toolcase.cc/units/pressure-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/pressure-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '壓力轉換器', url: 'https://toolcase.cc/zh-tw/units/pressure-converter' },
        ]}
      />
      <ToolSchema
        name="壓力轉換器"
        description="在壓力單位之間轉換，包括帕斯卡、巴、PSI、大氣壓、托爾、毫米汞柱等。支援所有常用壓力單位的即時轉換。"
        url="https://toolcase.cc/zh-tw/units/pressure-converter"
