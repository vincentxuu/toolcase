...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/units/clothing-size-chart', languages: { en: 'https://toolcase.cc/units/clothing-size-chart', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/clothing-size-chart' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '衣服尺寸對照表', url: 'https://toolcase.cc/zh-tw/units/clothing-size-chart' },
        ]}
      />
      <ToolSchema
        name="衣服尺寸對照表"
        description="男女裝國際尺碼對照表，含台灣、美國、歐洲、英國、日本尺碼換算。上衣與下身分別對照。"
        url="https://toolcase.cc/zh-tw/units/clothing-size-chart"
