...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/units/speed-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '速度轉換器', url: 'https://toolcase.cc/zh-tw/units/speed-converter' },
        ]}
      />
      <ToolSchema
        name="速度轉換器"
        description="在公里/時、英里/時、公尺/秒、節等單位之間輕鬆轉換。免費線上速度轉換器，即時顯示結果。"
        url="https://toolcase.cc/zh-tw/units/speed-converter"
