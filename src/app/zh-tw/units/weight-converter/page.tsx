...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/units/weight-converter',
    languages: {
      en: 'https://toolcase.cc/units/weight-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/weight-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '重量轉換器', url: 'https://toolcase.cc/zh-tw/units/weight-converter' },
        ]}
      />
      <ToolSchema
        name="重量轉換器"
        description="在公斤、磅、盎司、公克等單位之間輕鬆轉換。免費線上重量轉換器，即時顯示結果。"
        url="https://toolcase.cc/zh-tw/units/weight-converter"
