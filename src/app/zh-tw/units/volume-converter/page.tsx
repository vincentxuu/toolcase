...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/units/volume-converter',
    languages: {
      en: 'https://toolcase.cc/units/volume-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/units/volume-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '體積轉換器', url: 'https://toolcase.cc/zh-tw/units/volume-converter' },
        ]}
      />
      <ToolSchema
        name="體積轉換器"
        description="在公升、毫升、加侖、杯、液量盎司等單位之間輕鬆轉換。免費線上體積轉換器，即時顯示結果。"
        url="https://toolcase.cc/zh-tw/units/volume-converter"
