...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/calorie-calculator', languages: { en: 'https://toolcase.cc/calorie-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/calorie-calculator' } },
}
