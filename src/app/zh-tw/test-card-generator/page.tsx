...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/test-card-generator', languages: { en: 'https://toolcase.cc/test-card-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/test-card-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '測試卡號產生器', url: 'https://toolcase.cc/zh-tw/test-card-generator' },
        ]}
      />
      <ToolSchema
        name="測試卡號產生器"
        description="產生用於開發和測試的有效測試信用卡號。支援 Visa、MasterCard、美國運通、Discover、JCB 和 Diners Club。"
        url="https://toolcase.cc/zh-tw/test-card-generator"
