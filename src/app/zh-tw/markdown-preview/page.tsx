...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/markdown-preview', languages: { en: 'https://toolcase.cc/markdown-preview', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/markdown-preview' } },
}
