...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/url-encoder-decoder', languages: { en: 'https://toolcase.cc/url-encoder-decoder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/url-encoder-decoder' } },
}
