...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image-resizer', languages: { en: 'https://toolcase.cc/image-resizer', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image-resizer' } },
}
