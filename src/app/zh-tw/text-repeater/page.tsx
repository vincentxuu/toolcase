...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text-repeater', languages: { en: 'https://toolcase.cc/text-repeater', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text-repeater' } },
}
