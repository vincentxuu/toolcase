...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/tax-id-validator', languages: { en: 'https://toolcase.cc/tax-id-validator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/tax-id-validator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '統一編號驗證器', url: 'https://toolcase.cc/zh-tw/tax-id-validator' },
        ]}
      />
      <ToolSchema
        name="統一編號驗證器"
        description="使用官方算法驗證台灣公司行號統一編號。立即檢查8位數統一編號是否有效。"
        url="https://toolcase.cc/zh-tw/tax-id-validator"
