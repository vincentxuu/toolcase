...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image-cropper', languages: { en: 'https://toolcase.cc/image-cropper', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image-cropper' } },
}
