...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/braille-converter', languages: { en: 'https://toolcase.cc/braille-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/braille-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '盲文轉換', url: 'https://toolcase.cc/zh-tw/braille-converter' },
        ]}
      />
      <ToolSchema
        name="盲文轉換"
        description="將文字轉換為盲文或盲文轉換為文字。使用此線上轉換工具學習和練習盲文閱讀。"
        url="https://toolcase.cc/zh-tw/braille-converter"
