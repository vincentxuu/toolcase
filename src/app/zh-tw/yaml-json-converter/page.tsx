...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/yaml-json-converter', languages: { en: 'https://toolcase.cc/yaml-json-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/yaml-json-converter' } },
}
