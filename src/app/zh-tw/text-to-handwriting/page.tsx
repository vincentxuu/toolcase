...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text-to-handwriting', languages: { en: 'https://toolcase.cc/text-to-handwriting', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text-to-handwriting' } },
}
