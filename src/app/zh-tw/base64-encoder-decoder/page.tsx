...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/base64-encoder-decoder', languages: { en: 'https://toolcase.cc/base64-encoder-decoder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/base64-encoder-decoder' } },
}
