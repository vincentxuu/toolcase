...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/morse-code-translator', languages: { en: 'https://toolcase.cc/morse-code-translator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/morse-code-translator' } },
}
