...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/diff-checker', languages: { en: 'https://toolcase.cc/diff-checker', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/diff-checker' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '文字差異比較', url: 'https://toolcase.cc/zh-tw/diff-checker' },
        ]}
      />
      <ToolSchema
        name="文字差異比較"
        description="比較兩段文字並即時以顏色標示新增、刪除及修改的部分。免費線上 Diff 比較工具。"
        url="https://toolcase.cc/zh-tw/diff-checker"
