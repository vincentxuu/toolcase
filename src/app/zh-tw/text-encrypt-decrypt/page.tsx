...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text-encrypt-decrypt', languages: { en: 'https://toolcase.cc/text-encrypt-decrypt', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text-encrypt-decrypt' } },
}
