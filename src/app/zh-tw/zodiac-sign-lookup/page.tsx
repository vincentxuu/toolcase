...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/zodiac-sign-lookup', languages: { en: 'https://toolcase.cc/zodiac-sign-lookup', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/zodiac-sign-lookup' } },
}
