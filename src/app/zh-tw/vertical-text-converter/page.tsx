...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/vertical-text-converter', languages: { en: 'https://toolcase.cc/vertical-text-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/vertical-text-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '直書轉換', url: 'https://toolcase.cc/zh-tw/vertical-text-converter' },
        ]}
      />
      <ToolSchema
        name="直書轉換"
        description="將文字轉換為直式書寫格式。預覽中文、日文和韓文傳統直式排版。"
        url="https://toolcase.cc/zh-tw/vertical-text-converter"
