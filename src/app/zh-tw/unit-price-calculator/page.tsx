...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/unit-price-calculator', languages: { en: 'https://toolcase.cc/unit-price-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/unit-price-calculator' } },
}
