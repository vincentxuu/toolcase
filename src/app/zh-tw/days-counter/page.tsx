...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/days-counter', languages: { en: 'https://toolcase.cc/days-counter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/days-counter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '倒數日計算', url: 'https://toolcase.cc/zh-tw/days-counter' },
        ]}
      />
      <ToolSchema
        name="倒數日計算"
        description="計算距離任何日期的天數、小時、分鐘和秒數。非常適合追蹤生日、紀念日、截止日期和特殊活動。"
        url="https://toolcase.cc/zh-tw/days-counter"
