...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/number-to-words', languages: { en: 'https://toolcase.cc/number-to-words', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/number-to-words' } },
}
