...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/color-blindness-simulator', languages: { en: 'https://toolcase.cc/css/color-blindness-simulator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/color-blindness-simulator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '色盲模擬器', url: 'https://toolcase.cc/zh-tw/css/color-blindness-simulator' },
        ]}
      />
      <ToolSchema
        name="色盲模擬器"
        description="模擬色覺障礙者看到的顏色效果。即時預覽紅色盲、綠色盲、藍色盲等各種色覺缺陷類型。"
        url="https://toolcase.cc/zh-tw/css/color-blindness-simulator"
