...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/gradient-generator', languages: { en: 'https://toolcase.cc/css/gradient-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/gradient-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSS 漸層產生器', url: 'https://toolcase.cc/zh-tw/css/gradient-generator' },
        ]}
      />
      <ToolSchema
        name="CSS 漸層產生器"
        description="使用視覺化編輯器建立漂亮的 CSS 漸層。支援線性和放射狀漸層，可自訂多個色彩停駐點，即時預覽。"
        url="https://toolcase.cc/zh-tw/css/gradient-generator"
