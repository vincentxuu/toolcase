...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/css-text-shadow-generator', languages: { en: 'https://toolcase.cc/css/css-text-shadow-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/css-text-shadow-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '文字陰影產生器', url: 'https://toolcase.cc/zh-tw/css/css-text-shadow-generator' },
        ]}
      />
      <ToolSchema
        name="文字陰影產生器"
        description="視覺化產生 CSS text-shadow。調整偏移、模糊、顏色和透明度，支援多重陰影圖層和即時預覽。"
        url="https://toolcase.cc/zh-tw/css/css-text-shadow-generator"
