...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/css-clip-path-generator', languages: { en: 'https://toolcase.cc/css/css-clip-path-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/css-clip-path-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSS 裁切路徑產生器', url: 'https://toolcase.cc/zh-tw/css/css-clip-path-generator' },
        ]}
      />
      <ToolSchema
        name="CSS 裁切路徑產生器"
        description="視覺化產生 CSS clip-path 形狀。提供圓形、橢圓、三角形、多邊形、五邊形、六邊形和星形預設，即時預覽。"
        url="https://toolcase.cc/zh-tw/css/css-clip-path-generator"
