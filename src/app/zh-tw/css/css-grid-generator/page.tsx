...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/css-grid-generator', languages: { en: 'https://toolcase.cc/css/css-grid-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/css-grid-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSS Grid 產生器', url: 'https://toolcase.cc/zh-tw/css/css-grid-generator' },
        ]}
      />
      <ToolSchema
        name="CSS Grid 產生器"
        description="視覺化產生 CSS Grid 佈局。設定欄數、列數、間距和欄寬，支援 fr、px 和 auto 單位，即時預覽帶編號的格子。"
        url="https://toolcase.cc/zh-tw/css/css-grid-generator"
