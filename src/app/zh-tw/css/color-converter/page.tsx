...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/color-converter', languages: { en: 'https://toolcase.cc/css/color-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/color-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '色碼轉換器', url: 'https://toolcase.cc/zh-tw/css/color-converter' },
        ]}
      />
      <ToolSchema
        name="色碼轉換器"
        description="在 HEX、RGB 和 HSL 色碼格式之間轉換。免費線上色碼轉換器，附即時顏色預覽。"
        url="https://toolcase.cc/zh-tw/css/color-converter"
