...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/css-flexbox-playground', languages: { en: 'https://toolcase.cc/css/css-flexbox-playground', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/css-flexbox-playground' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSS Flexbox 互動練習場', url: 'https://toolcase.cc/zh-tw/css/css-flexbox-playground' },
        ]}
      />
      <ToolSchema
        name="CSS Flexbox 互動練習場"
        description="互動式 CSS Flexbox 練習場。調整 flex-direction、justify-content、align-items、flex-wrap 和 gap，即時視覺化預覽。"
        url="https://toolcase.cc/zh-tw/css/css-flexbox-playground"
