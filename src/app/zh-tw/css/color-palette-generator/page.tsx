...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/css/color-palette-generator', languages: { en: 'https://toolcase.cc/css/color-palette-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/css/color-palette-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '色彩調色盤產生器', url: 'https://toolcase.cc/zh-tw/css/color-palette-generator' },
        ]}
      />
      <ToolSchema
        name="色彩調色盤產生器"
        description="從任意基礎顏色產生和諧配色方案。支援互補色、類似色、三角色、分裂互補色和單色調配色，一鍵生成。"
        url="https://toolcase.cc/zh-tw/css/color-palette-generator"
