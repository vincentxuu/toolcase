...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/screen-recorder', languages: { en: 'https://toolcase.cc/screen-recorder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/screen-recorder' } },
}
