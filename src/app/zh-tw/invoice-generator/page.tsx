...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/invoice-generator', languages: { en: 'https://toolcase.cc/invoice-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/invoice-generator' } },
}
