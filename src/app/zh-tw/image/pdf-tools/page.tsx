...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image/pdf-tools', languages: { en: 'https://toolcase.cc/image/pdf-tools', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/pdf-tools' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'PDF 工具', url: 'https://toolcase.cc/zh-tw/image/pdf-tools' },
        ]}
      />
      <ToolSchema
        name="PDF 工具"
        description="線上檢視 PDF 檔案，查看檔案資訊並下載。免費 PDF 工具，無需安裝任何軟體。"
        url="https://toolcase.cc/zh-tw/image/pdf-tools"
