...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image/image-watermark', languages: { en: 'https://toolcase.cc/image/image-watermark', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/image-watermark' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '圖片浮水印', url: 'https://toolcase.cc/zh-tw/image/image-watermark' },
        ]}
      />
      <ToolSchema
        name="圖片浮水印"
        description="線上為圖片加上文字浮水印。可自訂文字、字體大小、顏色、透明度及位置。支援滿版浮水印。"
        url="https://toolcase.cc/zh-tw/image/image-watermark"
