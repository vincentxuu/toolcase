...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image/social-video-speed', languages: { en: 'https://toolcase.cc/image/social-video-speed', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/social-video-speed' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '社群影片快轉工具', url: 'https://toolcase.cc/zh-tw/image/social-video-speed' },
        ]}
      />
      <ToolSchema
        name="社群影片快轉工具"
        description="將長影片加速以符合社群媒體時間限制。預設 Instagram Reels、限時動態、Threads、Facebook Reels、TikTok、YouTube Shorts 和 X 的時長。在瀏覽器中處理。"
        url="https://toolcase.cc/zh-tw/image/social-video-speed"
