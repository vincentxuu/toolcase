...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image/aspect-ratio-calculator', languages: { en: 'https://toolcase.cc/image/aspect-ratio-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/aspect-ratio-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '長寬比計算器', url: 'https://toolcase.cc/zh-tw/image/aspect-ratio-calculator' },
        ]}
      />
      <ToolSchema
        name="長寬比計算器"
        description="即時計算並簡化長寬比。鎖定比例、使用 16:9、4:3、1:1 等預設值，快速找出任何解析度的簡化比例。"
        url="https://toolcase.cc/zh-tw/image/aspect-ratio-calculator"
