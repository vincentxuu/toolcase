...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image/webp-converter', languages: { en: 'https://toolcase.cc/image/webp-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/webp-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'WebP 轉換器', url: 'https://toolcase.cc/zh-tw/image/webp-converter' },
        ]}
      />
      <ToolSchema
        name="WebP 轉換器"
        description="在瀏覽器中轉換 WebP、PNG 和 JPG 圖片格式。調整品質並比較檔案大小。無需上傳，100% 隱私。"
        url="https://toolcase.cc/zh-tw/image/webp-converter"
