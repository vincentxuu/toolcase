...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image/image-converter', languages: { en: 'https://toolcase.cc/image/image-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/image-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '圖片格式轉換', url: 'https://toolcase.cc/zh-tw/image/image-converter' },
        ]}
      />
      <ToolSchema
        name="圖片格式轉換"
        description="線上轉換圖片格式，支援 JPEG、PNG、WebP 等格式互轉。免費圖片轉檔工具，快速又簡單。"
        url="https://toolcase.cc/zh-tw/image/image-converter"
