...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/image/image-compressor', languages: { en: 'https://toolcase.cc/image/image-compressor', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/image/image-compressor' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '圖片壓縮', url: 'https://toolcase.cc/zh-tw/image/image-compressor' },
        ]}
      />
      <ToolSchema
        name="圖片壓縮"
        description="線上壓縮圖片檔案大小，支援調整品質與格式。免費圖片壓縮工具，在瀏覽器中即可完成。"
        url="https://toolcase.cc/zh-tw/image/image-compressor"
