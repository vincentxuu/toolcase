...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/tip-calculator', languages: { en: 'https://toolcase.cc/tip-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/tip-calculator' } },
}
