...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/body-fat-calculator', languages: { en: 'https://toolcase.cc/body-fat-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/body-fat-calculator' } },
}
