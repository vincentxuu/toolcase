...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text/emoji-search', languages: { en: 'https://toolcase.cc/text/emoji-search', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/emoji-search' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '表情符號搜尋', url: 'https://toolcase.cc/zh-tw/text/emoji-search' },
        ]}
      />
      <ToolSchema
        name="表情符號搜尋"
        description="快速搜尋並複製表情符號。輸入關鍵字即可找到想要的 Emoji，一鍵複製到剪貼簿。"
        url="https://toolcase.cc/zh-tw/text/emoji-search"
