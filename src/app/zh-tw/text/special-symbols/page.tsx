...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text/special-symbols', languages: { en: 'https://toolcase.cc/text/special-symbols', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/special-symbols' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '特殊符號表', url: 'https://toolcase.cc/zh-tw/text/special-symbols' },
        ]}
      />
      <ToolSchema
        name="特殊符號表"
        description="箭頭、勾叉、愛心、星星、數學符號、貨幣符號等，點擊即可複製貼上。"
        url="https://toolcase.cc/zh-tw/text/special-symbols"
