...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text/bopomofo-converter', languages: { en: 'https://toolcase.cc/text/bopomofo-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/bopomofo-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '注音轉換', url: 'https://toolcase.cc/zh-tw/text/bopomofo-converter' },
        ]}
      />
      <ToolSchema
        name="注音轉換"
        description="將中文字轉換為注音符號。使用此轉換工具學習台灣注音系統。"
        url="https://toolcase.cc/zh-tw/text/bopomofo-converter"
