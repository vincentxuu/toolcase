...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text/fancy-text-generator', languages: { en: 'https://toolcase.cc/text/fancy-text-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/fancy-text-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '花式文字產生器', url: 'https://toolcase.cc/zh-tw/text/fancy-text-generator' },
        ]}
      />
      <ToolSchema
        name="花式文字產生器"
        description="產生各種花式文字，包含粗體、斜體、手寫體、哥特體、雙線體、等寬、圓圈、全形、上下顛倒和小型大寫字母等 Unicode 樣式。可複製貼上至任何地方。"
        url="https://toolcase.cc/zh-tw/text/fancy-text-generator"
