...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text/social-media-counter', languages: { en: 'https://toolcase.cc/text/social-media-counter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/social-media-counter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '社群媒體字數計算器', url: 'https://toolcase.cc/zh-tw/text/social-media-counter' },
        ]}
      />
      <ToolSchema
        name="社群媒體字數計算器"
        description="計算文字在各社群平台的字元數，支援 Twitter、Instagram、Facebook 等平台的字數限制檢查。"
        url="https://toolcase.cc/zh-tw/text/social-media-counter"
