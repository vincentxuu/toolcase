...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text/remove-duplicates', languages: { en: 'https://toolcase.cc/text/remove-duplicates', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/remove-duplicates' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '移除重複行', url: 'https://toolcase.cc/zh-tw/text/remove-duplicates' },
        ]}
      />
      <ToolSchema
        name="移除重複行"
        description="快速移除文字中的重複行。支援大小寫區分、空白修剪和排序輸出等選項。"
        url="https://toolcase.cc/zh-tw/text/remove-duplicates"
