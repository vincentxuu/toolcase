...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/text/text-to-speech', languages: { en: 'https://toolcase.cc/text/text-to-speech', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/text/text-to-speech' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '文字轉語音', url: 'https://toolcase.cc/zh-tw/text/text-to-speech' },
        ]}
      />
      <ToolSchema
        name="文字轉語音"
        description="將文字轉換為語音朗讀，支援多種語音、速度和音調調整。免費線上 TTS 文字轉語音工具。"
        url="https://toolcase.cc/zh-tw/text/text-to-speech"
