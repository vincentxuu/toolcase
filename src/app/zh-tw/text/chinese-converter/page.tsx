...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/text/chinese-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '簡繁轉換', url: 'https://toolcase.cc/zh-tw/text/chinese-converter' },
        ]}
      />
      <ToolSchema
        name="簡繁轉換"
        description="即時在簡體中文和繁體中文之間轉換。免費線上簡繁轉換工具，即時轉換、不需註冊。"
        url="https://toolcase.cc/zh-tw/text/chinese-converter"
