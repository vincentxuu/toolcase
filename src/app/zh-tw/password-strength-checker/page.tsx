...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/password-strength-checker', languages: { en: 'https://toolcase.cc/password-strength-checker', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/password-strength-checker' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '密碼強度檢查器', url: 'https://toolcase.cc/zh-tw/password-strength-checker' },
        ]}
      />
      <ToolSchema
        name="密碼強度檢查器"
        description="立即檢查密碼強度，獲得詳細的密碼安全性反饋與需求檢查清單。所有檢查都在您的瀏覽器中進行。"
        url="https://toolcase.cc/zh-tw/password-strength-checker"
