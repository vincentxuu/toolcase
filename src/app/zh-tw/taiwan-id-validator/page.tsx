...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/taiwan-id-validator', languages: { en: 'https://toolcase.cc/taiwan-id-validator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/taiwan-id-validator' } },
}
