...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/regex-tester', languages: { en: 'https://toolcase.cc/regex-tester', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/regex-tester' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '正規表達式測試器', url: 'https://toolcase.cc/zh-tw/regex-tester' },
        ]}
      />
      <ToolSchema
        name="正規表達式測試器"
        description="即時測試和除錯正規表達式，支援即時高亮顯示。免費線上正規表達式測試工具。"
        url="https://toolcase.cc/zh-tw/regex-tester"
