...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/finance/tw-minimum-wage', languages: { en: 'https://toolcase.cc/finance/tw-minimum-wage', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-minimum-wage' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '基本工資歷年表', url: 'https://toolcase.cc/zh-tw/finance/tw-minimum-wage' },
        ]}
      />
      <ToolSchema
        name="基本工資歷年表"
        description="台灣基本工資歷年一覽（2011~2025），含月薪、時薪、生效日期與歷年調幅。2025年月薪28,590元、時薪190元。"
        url="https://toolcase.cc/zh-tw/finance/tw-minimum-wage"
