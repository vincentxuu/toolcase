...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/finance/roi-calculator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '投資報酬率計算器', url: 'https://toolcase.cc/zh-tw/finance/roi-calculator' },
        ]}
      />
      <ToolSchema
        name="投資報酬率計算器"
        description="計算投資報酬率（ROI）和年化報酬率。簡單好用的免費投資回報計算器。"
        url="https://toolcase.cc/zh-tw/finance/roi-calculator"
