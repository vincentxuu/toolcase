...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/finance/loan-calculator',
    languages: {
      en: 'https://toolcase.cc/finance/loan-calculator',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/loan-calculator',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '貸款計算器', url: 'https://toolcase.cc/zh-tw/finance/loan-calculator' },
        ]}
      />
      <ToolSchema
        name="貸款計算器"
        description="計算每月貸款還款金額、總利息支出，適用於汽車貸款、個人貸款和學生貸款。"
        url="https://toolcase.cc/zh-tw/finance/loan-calculator"
