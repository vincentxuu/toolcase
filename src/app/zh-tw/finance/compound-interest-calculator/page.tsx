...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/finance/compound-interest-calculator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '複利計算器', url: 'https://toolcase.cc/zh-tw/finance/compound-interest-calculator' },
        ]}
      />
      <ToolSchema
        name="複利計算器"
        description="計算複利增長，包含每月定期投入。以互動圖表查看你的投資如何隨時間成長。"
        url="https://toolcase.cc/zh-tw/finance/compound-interest-calculator"
