...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/finance/tw-tax-deductions', languages: { en: 'https://toolcase.cc/finance/tw-tax-deductions', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-tax-deductions' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '免稅額與扣除額一覽', url: 'https://toolcase.cc/zh-tw/finance/tw-tax-deductions' },
        ]}
      />
      <ToolSchema
        name="免稅額與扣除額一覽"
        description="113年度綜合所得稅免稅額、標準/列舉扣除額、特別扣除額完整對照表，含基本生活費差額說明。"
        url="https://toolcase.cc/zh-tw/finance/tw-tax-deductions"
