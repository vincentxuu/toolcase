...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/finance/tw-income-tax-brackets', languages: { en: 'https://toolcase.cc/finance/tw-income-tax-brackets', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-income-tax-brackets' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '綜合所得稅級距表', url: 'https://toolcase.cc/zh-tw/finance/tw-income-tax-brackets' },
        ]}
      />
      <ToolSchema
        name="綜合所得稅級距表"
        description="台灣綜合所得稅級距表（113年度/2024適用），5%~40%累進稅率、累進差額速算公式，含快速試算功能。"
        url="https://toolcase.cc/zh-tw/finance/tw-income-tax-brackets"
