...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/finance/tw-gift-tax', languages: { en: 'https://toolcase.cc/finance/tw-gift-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-gift-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '贈與稅級距表', url: 'https://toolcase.cc/zh-tw/finance/tw-gift-tax' },
        ]}
      />
      <ToolSchema
        name="贈與稅級距表"
        description="贈與稅三級累進稅率（10%/15%/20%）級距表，每人每年免稅額244萬元，含快速試算功能。"
        url="https://toolcase.cc/zh-tw/finance/tw-gift-tax"
