...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/finance/tw-house-tax', languages: { en: 'https://toolcase.cc/finance/tw-house-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-house-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '房屋稅稅率表', url: 'https://toolcase.cc/zh-tw/finance/tw-house-tax' },
        ]}
      />
      <ToolSchema
        name="房屋稅稅率表"
        description="房屋稅稅率對照表，含自住1.2%、非自住累進稅率（囤房稅2.0）、營業用3%，及計算方式說明。"
        url="https://toolcase.cc/zh-tw/finance/tw-house-tax"
