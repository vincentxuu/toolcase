...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/finance/savings-calculator',
    languages: {
      en: 'https://toolcase.cc/finance/savings-calculator',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/savings-calculator',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '存款利息計算器', url: 'https://toolcase.cc/zh-tw/finance/savings-calculator' },
        ]}
      />
      <ToolSchema
        name="存款利息計算器"
        description="計算定期存款搭配複利的成長。免費存款成長計算器，附互動圖表。"
        url="https://toolcase.cc/zh-tw/finance/savings-calculator"
