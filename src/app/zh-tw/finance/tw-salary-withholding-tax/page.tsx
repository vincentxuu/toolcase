...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/finance/tw-salary-withholding-tax', languages: { en: 'https://toolcase.cc/finance/tw-salary-withholding-tax', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/finance/tw-salary-withholding-tax' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '薪資扣繳稅額表', url: 'https://toolcase.cc/zh-tw/finance/tw-salary-withholding-tax' },
        ]}
      />
      <ToolSchema
        name="薪資扣繳稅額表"
        description="薪資所得扣繳稅額表（114年度適用），含居住者與非居住者扣繳率對照，輸入月薪即可查詢每月扣繳金額。"
        url="https://toolcase.cc/zh-tw/finance/tw-salary-withholding-tax"
