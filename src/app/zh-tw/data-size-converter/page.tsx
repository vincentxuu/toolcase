...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/data-size-converter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '資料大小轉換器', url: 'https://toolcase.cc/zh-tw/data-size-converter' },
        ]}
      />
      <ToolSchema
        name="資料大小轉換器"
        description="在 Bytes、KB、MB、GB、TB、PB 等單位之間輕鬆轉換。免費線上資料大小轉換器，即時顯示結果。"
        url="https://toolcase.cc/zh-tw/data-size-converter"
