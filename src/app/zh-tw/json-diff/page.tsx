...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/json-diff', languages: { en: 'https://toolcase.cc/json-diff', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/json-diff' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JSON 差異比較', url: 'https://toolcase.cc/zh-tw/json-diff' },
        ]}
      />
      <ToolSchema
        name="JSON 差異比較"
        description="比較兩個 JSON 物件並以語法高亮顯示差異。支援統一和分割視圖、JSON 和文字模式比較。免費瀏覽器工具。"
        url="https://toolcase.cc/zh-tw/json-diff"
