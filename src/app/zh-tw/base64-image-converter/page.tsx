...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/base64-image-converter', languages: { en: 'https://toolcase.cc/base64-image-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/base64-image-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Base64 圖片轉換', url: 'https://toolcase.cc/zh-tw/base64-image-converter' },
        ]}
      />
      <ToolSchema
        name="Base64 圖片轉換"
        description="將圖片轉換為 Base64 資料 URL，或將 Base64 解碼回圖片。預覽圖片、查看尺寸和檔案大小。免費瀏覽器工具。"
        url="https://toolcase.cc/zh-tw/base64-image-converter"
