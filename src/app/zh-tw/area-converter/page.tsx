...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/area-converter',
    languages: {
      en: 'https://toolcase.cc/area-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/area-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '面積轉換器', url: 'https://toolcase.cc/zh-tw/area-converter' },
        ]}
      />
      <ToolSchema
        name="面積轉換器"
        description="在平方公尺、坪、公頃、英畝、平方英尺等單位之間輕鬆轉換。支援台灣常用的坪數換算，免費線上面積轉換器。"
        url="https://toolcase.cc/zh-tw/area-converter"
