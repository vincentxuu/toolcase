...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/excel-formula-generator', languages: { en: 'https://toolcase.cc/excel-formula-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/excel-formula-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Excel 公式產生器', url: 'https://toolcase.cc/zh-tw/excel-formula-generator' },
        ]}
      />
      <ToolSchema
        name="Excel 公式產生器"
        description="瀏覽並複製常用 Excel 公式與語法範例。包括數學、統計、邏輯、文字、日期、查詢和財務函數。免費參考工具。"
        url="https://toolcase.cc/zh-tw/excel-formula-generator"
