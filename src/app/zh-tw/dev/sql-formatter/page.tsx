...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/sql-formatter',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'SQL 格式化工具', url: 'https://toolcase.cc/zh-tw/dev/sql-formatter' },
        ]}
      />
      <ToolSchema
        name="SQL 格式化工具"
        description="即時格式化和美化 SQL 查詢。將關鍵字大寫，加上適當的縮排和換行，讓 SQL 更易閱讀。"
        url="https://toolcase.cc/zh-tw/dev/sql-formatter"
