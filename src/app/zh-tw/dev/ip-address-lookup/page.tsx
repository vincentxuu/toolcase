...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/ip-address-lookup', languages: { en: 'https://toolcase.cc/dev/ip-address-lookup', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/ip-address-lookup' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'IP 位址查詢', url: 'https://toolcase.cc/zh-tw/dev/ip-address-lookup' },
        ]}
      />
      <ToolSchema
        name="IP 位址查詢"
        description="查詢任何 IP 位址的地理位置、ISP、時區和座標資訊。自動偵測您的 IP 位址。免費即時查詢。"
        url="https://toolcase.cc/zh-tw/dev/ip-address-lookup"
