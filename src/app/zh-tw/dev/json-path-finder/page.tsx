...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/json-path-finder', languages: { en: 'https://toolcase.cc/dev/json-path-finder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/json-path-finder' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JSON 路徑查找器', url: 'https://toolcase.cc/zh-tw/dev/json-path-finder' },
        ]}
      />
      <ToolSchema
        name="JSON 路徑查找器"
        description="貼上 JSON 並以樹狀檢視探索其結構。點擊任何節點即可取得其 JSON 路徑（點表示法或括號表示法）。一鍵複製路徑到剪貼簿。"
        url="https://toolcase.cc/zh-tw/dev/json-path-finder"
