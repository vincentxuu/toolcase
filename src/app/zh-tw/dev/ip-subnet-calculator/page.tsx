...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/ip-subnet-calculator', languages: { en: 'https://toolcase.cc/dev/ip-subnet-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/ip-subnet-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'IP 子網路計算器', url: 'https://toolcase.cc/zh-tw/dev/ip-subnet-calculator' },
        ]}
      />
      <ToolSchema
        name="IP 子網路計算器"
        description="根據任何 IP 位址和 CIDR 表示法計算子網路詳情，包括網路位址、廣播位址、子網路遮罩、主機範圍和可用主機總數。"
        url="https://toolcase.cc/zh-tw/dev/ip-subnet-calculator"
