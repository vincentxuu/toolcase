...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/html-entity-encoder', languages: { en: 'https://toolcase.cc/dev/html-entity-encoder', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/html-entity-encoder' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTML 實體編碼/解碼器', url: 'https://toolcase.cc/zh-tw/dev/html-entity-encoder' },
        ]}
      />
      <ToolSchema
        name="HTML 實體編碼/解碼器"
        description="線上編碼與解碼 HTML 實體。將特殊字元轉換為 HTML 實體，或將 HTML 實體還原為字元。支援具名與數值實體。"
        url="https://toolcase.cc/zh-tw/dev/html-entity-encoder"
