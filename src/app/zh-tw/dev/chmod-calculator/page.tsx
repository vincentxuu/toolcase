...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/chmod-calculator', languages: { en: 'https://toolcase.cc/dev/chmod-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/chmod-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Chmod 計算器', url: 'https://toolcase.cc/zh-tw/dev/chmod-calculator' },
        ]}
      />
      <ToolSchema
        name="Chmod 計算器"
        description="使用互動式 chmod 計算器計算 Unix 檔案權限。切換擁有者、群組和其他人的讀取、寫入和執行權限，即時取得數字和符號表示法。"
        url="https://toolcase.cc/zh-tw/dev/chmod-calculator"
