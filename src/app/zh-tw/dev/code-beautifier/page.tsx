...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/code-beautifier',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTML/CSS/JS 美化工具', url: 'https://toolcase.cc/zh-tw/dev/code-beautifier' },
        ]}
      />
      <ToolSchema
        name="HTML/CSS/JS 美化工具"
        description="即時美化和格式化 HTML、CSS 和 JavaScript 程式碼。為壓縮或雜亂的程式碼加上適當的縮排和格式。"
        url="https://toolcase.cc/zh-tw/dev/code-beautifier"
