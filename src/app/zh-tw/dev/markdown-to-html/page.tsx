...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/markdown-to-html', languages: { en: 'https://toolcase.cc/dev/markdown-to-html', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/markdown-to-html' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Markdown 轉 HTML 轉換器', url: 'https://toolcase.cc/zh-tw/dev/markdown-to-html' },
        ]}
      />
      <ToolSchema
        name="Markdown 轉 HTML 轉換器"
        description="將 Markdown 文字轉換為乾淨的 HTML 原始碼。免費線上 Markdown 轉 HTML 工具，適合開發者與內容創作者使用。"
        url="https://toolcase.cc/zh-tw/dev/markdown-to-html"
