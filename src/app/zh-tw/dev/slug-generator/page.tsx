...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/slug-generator', languages: { en: 'https://toolcase.cc/dev/slug-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/slug-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Slug 產生器', url: 'https://toolcase.cc/zh-tw/dev/slug-generator' },
        ]}
      />
      <ToolSchema
        name="Slug 產生器"
        description="將文字轉換為適合網址的 slug。可自訂分隔符號、大小寫及長度限制。免費線上 slug 產生器。"
        url="https://toolcase.cc/zh-tw/dev/slug-generator"
