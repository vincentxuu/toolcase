...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/integer-base-converter', languages: { en: 'https://toolcase.cc/dev/integer-base-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/integer-base-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '整數進位轉換器', url: 'https://toolcase.cc/zh-tw/dev/integer-base-converter' },
        ]}
      />
      <ToolSchema
        name="整數進位轉換器"
        description="在二進位、八進位、十進位、十六進位及自訂進位之間轉換數字。免費線上進位轉換工具。"
        url="https://toolcase.cc/zh-tw/dev/integer-base-converter"
