...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/open-graph-preview', languages: { en: 'https://toolcase.cc/dev/open-graph-preview', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/open-graph-preview' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Open Graph 預覽', url: 'https://toolcase.cc/zh-tw/dev/open-graph-preview' },
        ]}
      />
      <ToolSchema
        name="Open Graph 預覽"
        description="預覽網頁在 Facebook、Twitter 和 LinkedIn 等社群平台分享時的顯示效果，並產生 OG Meta 標籤。"
        url="https://toolcase.cc/zh-tw/dev/open-graph-preview"
