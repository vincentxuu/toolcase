...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/csv-editor', languages: { en: 'https://toolcase.cc/dev/csv-editor', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/csv-editor' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSV 編輯器', url: 'https://toolcase.cc/zh-tw/dev/csv-editor' },
        ]}
      />
      <ToolSchema
        name="CSV 編輯器"
        description="在視覺化試算表介面中編輯 CSV 檔案。新增、刪除、修改行和列。支援多種分隔符號。下載編輯後的 CSV。免費瀏覽器工具。"
        url="https://toolcase.cc/zh-tw/dev/csv-editor"
