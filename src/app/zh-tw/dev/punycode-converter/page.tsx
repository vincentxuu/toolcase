...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/punycode-converter', languages: { en: 'https://toolcase.cc/dev/punycode-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/punycode-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Punycode 轉換', url: 'https://toolcase.cc/zh-tw/dev/punycode-converter' },
        ]}
      />
      <ToolSchema
        name="Punycode 轉換"
        description="將國際化域名（IDN）轉換為 Punycode 格式。編碼和解碼非 ASCII 域名以實現 DNS 相容性。"
        url="https://toolcase.cc/zh-tw/dev/punycode-converter"
