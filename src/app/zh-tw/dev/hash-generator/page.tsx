...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/hash-generator', languages: { en: 'https://toolcase.cc/dev/hash-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/hash-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '雜湊產生器', url: 'https://toolcase.cc/zh-tw/dev/hash-generator' },
        ]}
      />
      <ToolSchema
        name="雜湊產生器"
        description="產生 MD5、SHA-1、SHA-256、SHA-512 等雜湊值。免費線上雜湊產生器，支援文字和檔案。"
        url="https://toolcase.cc/zh-tw/dev/hash-generator"
