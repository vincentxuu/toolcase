...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/http-status-codes', languages: { en: 'https://toolcase.cc/dev/http-status-codes', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/http-status-codes' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTTP 狀態碼查詢', url: 'https://toolcase.cc/zh-tw/dev/http-status-codes' },
        ]}
      />
      <ToolSchema
        name="HTTP 狀態碼查詢"
        description="完整的 HTTP 狀態碼參考手冊，附說明。可搜尋與篩選 1xx 到 5xx 所有狀態碼。網頁開發者的快速參考工具。"
        url="https://toolcase.cc/zh-tw/dev/http-status-codes"
