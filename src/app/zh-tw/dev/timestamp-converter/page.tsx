...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/timestamp-converter',
    languages: {
      en: 'https://toolcase.cc/dev/timestamp-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/timestamp-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '時間戳轉換器', url: 'https://toolcase.cc/zh-tw/dev/timestamp-converter' },
        ]}
      />
      <ToolSchema
        name="時間戳轉換器"
        description="在 Unix 時間戳和人類可讀日期之間轉換。免費線上時間戳轉換器，提供即時時鐘、相對時間和 ISO 8601 輸出。"
        url="https://toolcase.cc/zh-tw/dev/timestamp-converter"
