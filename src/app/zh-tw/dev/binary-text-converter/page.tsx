...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/binary-text-converter', languages: { en: 'https://toolcase.cc/dev/binary-text-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/binary-text-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '二進位文字轉換器', url: 'https://toolcase.cc/zh-tw/dev/binary-text-converter' },
        ]}
      />
      <ToolSchema
        name="二進位文字轉換器"
        description="即時將文字轉換為二進位碼，或將二進位碼轉回文字。將任何文字編碼為 8 位元二進位位元組。"
        url="https://toolcase.cc/zh-tw/dev/binary-text-converter"
