...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/ai-token-counter', languages: { en: 'https://toolcase.cc/dev/ai-token-counter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/ai-token-counter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'AI Token 計算器與成本估算', url: 'https://toolcase.cc/zh-tw/dev/ai-token-counter' },
        ]}
      />
      <ToolSchema
        name="AI Token 計算器與成本估算"
        description="計算 Token 數量並估算 GPT-4o、Claude、Gemini 等 AI 模型的 API 費用。免費線上 AI Token 計算器。"
        url="https://toolcase.cc/zh-tw/dev/ai-token-counter"
