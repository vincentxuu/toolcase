...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/favicon-generator', languages: { en: 'https://toolcase.cc/dev/favicon-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/favicon-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Favicon 產生器', url: 'https://toolcase.cc/zh-tw/dev/favicon-generator' },
        ]}
      />
      <ToolSchema
        name="Favicon 產生器"
        description="從圖片或文字產生所有標準尺寸的 Favicon 圖示，附帶可直接使用的 HTML 標籤。免費線上工具。"
        url="https://toolcase.cc/zh-tw/dev/favicon-generator"
