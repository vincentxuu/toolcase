...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/bcrypt-generator',
    languages: {
      en: 'https://toolcase.cc/dev/bcrypt-generator',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/bcrypt-generator',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '密碼雜湊產生器', url: 'https://toolcase.cc/zh-tw/dev/bcrypt-generator' },
        ]}
      />
      <ToolSchema
        name="密碼雜湊產生器"
        description="從密碼生成 SHA-256、SHA-384 和 SHA-512 雜湊值。支援加鹽以增強安全性。所有處理在瀏覽器中完成。"
        url="https://toolcase.cc/zh-tw/dev/bcrypt-generator"
