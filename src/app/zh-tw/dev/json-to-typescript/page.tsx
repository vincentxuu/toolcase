...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/json-to-typescript',
    languages: {
      en: 'https://toolcase.cc/dev/json-to-typescript',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/json-to-typescript',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JSON 轉 TypeScript', url: 'https://toolcase.cc/zh-tw/dev/json-to-typescript' },
        ]}
      />
      <ToolSchema
        name="JSON 轉 TypeScript"
        description="即時將 JSON 資料轉換為 TypeScript 介面和型別定義。支援巢狀物件、陣列和可選欄位。"
        url="https://toolcase.cc/zh-tw/dev/json-to-typescript"
