...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/csv-json-converter', languages: { en: 'https://toolcase.cc/dev/csv-json-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/csv-json-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'CSV JSON 轉換器', url: 'https://toolcase.cc/zh-tw/dev/csv-json-converter' },
        ]}
      />
      <ToolSchema
        name="CSV JSON 轉換器"
        description="即時在 CSV 和 JSON 格式之間轉換。支援 CSV 轉 JSON 及 JSON 轉 CSV，所有處理皆在瀏覽器本機完成。"
        url="https://toolcase.cc/zh-tw/dev/csv-json-converter"
