...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/jwt-decoder',
    languages: {
      en: 'https://toolcase.cc/dev/jwt-decoder',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/jwt-decoder',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'JWT 解碼器', url: 'https://toolcase.cc/zh-tw/dev/jwt-decoder' },
        ]}
      />
      <ToolSchema
        name="JWT 解碼器"
        description="即時解碼與檢視 JWT（JSON Web Token）。查看標頭、載荷、過期時間和聲明，所有處理在瀏覽器中完成。"
        url="https://toolcase.cc/zh-tw/dev/jwt-decoder"
