...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/meta-tag-generator', languages: { en: 'https://toolcase.cc/dev/meta-tag-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/meta-tag-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Meta 標籤產生器', url: 'https://toolcase.cc/zh-tw/dev/meta-tag-generator' },
        ]}
      />
      <ToolSchema
        name="Meta 標籤產生器"
        description="產生 SEO 優化的 HTML Meta 標籤，包含標題、描述、Open Graph 和 robots 設定。免費 Meta Tag 產生器。"
        url="https://toolcase.cc/zh-tw/dev/meta-tag-generator"
