...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/cron-expression-generator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Cron 表達式產生器', url: 'https://toolcase.cc/zh-tw/dev/cron-expression-generator' },
        ]}
      />
      <ToolSchema
        name="Cron 表達式產生器"
        description="視覺化建立與理解 Cron 表達式。免費線上 Cron 產生器，提供預設範本、人類可讀說明和便捷編輯。"
        url="https://toolcase.cc/zh-tw/dev/cron-expression-generator"
