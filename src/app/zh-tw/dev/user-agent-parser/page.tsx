...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/user-agent-parser',
    languages: {
      en: 'https://toolcase.cc/dev/user-agent-parser',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/user-agent-parser',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'User', url: 'https://toolcase.cc/zh-tw/dev/user-agent-parser' },
        ]}
      />
      <ToolSchema
        name="User"
        description="即時解析和分析 User-Agent 字串。從任何 User-Agent 中偵測瀏覽器、作業系統、裝置類型和渲染引擎。"
        url="https://toolcase.cc/zh-tw/dev/user-agent-parser"
