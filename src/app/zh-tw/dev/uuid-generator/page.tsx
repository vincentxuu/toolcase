...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/dev/uuid-generator', languages: { en: 'https://toolcase.cc/dev/uuid-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/uuid-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'UUID 產生器', url: 'https://toolcase.cc/zh-tw/dev/uuid-generator' },
        ]}
      />
      <ToolSchema
        name="UUID 產生器"
        description="即時產生 UUID v4 與 ULID 唯一識別碼。支援批次產生，免費線上 UUID 產生器。"
        url="https://toolcase.cc/zh-tw/dev/uuid-generator"
