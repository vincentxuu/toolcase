...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/dev/unicode-converter',
    languages: {
      en: 'https://toolcase.cc/dev/unicode-converter',
      'zh-Hant-TW': 'https://toolcase.cc/zh-tw/dev/unicode-converter',
    },
  },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Unicode 轉換器', url: 'https://toolcase.cc/zh-tw/dev/unicode-converter' },
        ]}
      />
      <ToolSchema
        name="Unicode 轉換器"
        description="編碼與解碼 Unicode 字元。將文字轉換為 Unicode 跳脫序列、HTML 實體、CSS 跳脫和碼位。"
        url="https://toolcase.cc/zh-tw/dev/unicode-converter"
