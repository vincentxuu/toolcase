...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/svg-to-png-converter', languages: { en: 'https://toolcase.cc/svg-to-png-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/svg-to-png-converter' } },
}
