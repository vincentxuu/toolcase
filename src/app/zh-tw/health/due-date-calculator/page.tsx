...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/health/due-date-calculator', languages: { en: 'https://toolcase.cc/health/due-date-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/due-date-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '預產期計算器', url: 'https://toolcase.cc/zh-tw/health/due-date-calculator' },
        ]}
      />
      <ToolSchema
        name="預產期計算器"
        description="根據最後一次月經日期計算預產期。追蹤懷孕週數和孕期階段。"
        url="https://toolcase.cc/zh-tw/health/due-date-calculator"
