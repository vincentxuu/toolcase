...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/health/tdee-calculator', languages: { en: 'https://toolcase.cc/health/tdee-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/tdee-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'TDEE / BMR 計算器', url: 'https://toolcase.cc/zh-tw/health/tdee-calculator' },
        ]}
      />
      <ToolSchema
        name="TDEE / BMR 計算器"
        description="計算你的每日總消耗熱量 (TDEE) 和基礎代謝率 (BMR)。精確了解你每天需要多少熱量。"
        url="https://toolcase.cc/zh-tw/health/tdee-calculator"
