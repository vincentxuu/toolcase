...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/health/heart-rate-calculator', languages: { en: 'https://toolcase.cc/health/heart-rate-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/health/heart-rate-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '心率區間計算器', url: 'https://toolcase.cc/zh-tw/health/heart-rate-calculator' },
        ]}
      />
      <ToolSchema
        name="心率區間計算器"
        description="計算個人化的心率訓練區間。免費線上心率區間計算器，幫助您優化運動訓練效果。"
        url="https://toolcase.cc/zh-tw/health/heart-rate-calculator"
