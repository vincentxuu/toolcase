...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/fuel-cost-calculator', languages: { en: 'https://toolcase.cc/everyday/fuel-cost-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/fuel-cost-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '油費計算器', url: 'https://toolcase.cc/zh-tw/everyday/fuel-cost-calculator' },
        ]}
      />
      <ToolSchema
        name="油費計算器"
        description="計算旅程的油費。輸入距離、油耗和油價，估算需要多少油量和費用。"
        url="https://toolcase.cc/zh-tw/everyday/fuel-cost-calculator"
