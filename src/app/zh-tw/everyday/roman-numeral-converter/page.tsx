...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/roman-numeral-converter', languages: { en: 'https://toolcase.cc/everyday/roman-numeral-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/roman-numeral-converter' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '羅馬數字轉換器', url: 'https://toolcase.cc/zh-tw/everyday/roman-numeral-converter' },
        ]}
      />
      <ToolSchema
        name="羅馬數字轉換器"
        description="即時在十進位數字和羅馬數字之間互相轉換。支援 1 到 3999 的數值，附完整轉換參考表。"
        url="https://toolcase.cc/zh-tw/everyday/roman-numeral-converter"
