...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/typing-speed-test', languages: { en: 'https://toolcase.cc/everyday/typing-speed-test', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/typing-speed-test' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '打字速度測試', url: 'https://toolcase.cc/zh-tw/everyday/typing-speed-test' },
        ]}
      />
      <ToolSchema
        name="打字速度測試"
        description="使用免費線上打字測試來測試您的打字速度和準確度。即時測量每分鐘字數（WPM）、淨 WPM 和準確度。"
        url="https://toolcase.cc/zh-tw/everyday/typing-speed-test"
