...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/random-number-generator', languages: { en: 'https://toolcase.cc/everyday/random-number-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/random-number-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '隨機數字產生器', url: 'https://toolcase.cc/zh-tw/everyday/random-number-generator' },
        ]}
      />
      <ToolSchema
        name="隨機數字產生器"
        description="在指定範圍內產生隨機數字。支援多個數字、不重複和排序選項。免費線上隨機數字產生器。"
        url="https://toolcase.cc/zh-tw/everyday/random-number-generator"
