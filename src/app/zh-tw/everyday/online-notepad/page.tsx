...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/online-notepad', languages: { en: 'https://toolcase.cc/everyday/online-notepad', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/online-notepad' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '線上記事本', url: 'https://toolcase.cc/zh-tw/everyday/online-notepad' },
        ]}
      />
      <ToolSchema
        name="線上記事本"
        description="使用免費線上記事本即時撰寫和儲存筆記。具備自動儲存至本地端、字元與字數統計，以及下載為 .txt 檔案等功能。"
        url="https://toolcase.cc/zh-tw/everyday/online-notepad"
