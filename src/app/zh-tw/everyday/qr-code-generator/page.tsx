...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://toolcase.cc/zh-tw/everyday/qr-code-generator',
    languages: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'QR Code 產生器', url: 'https://toolcase.cc/zh-tw/everyday/qr-code-generator' },
        ]}
      />
      <ToolSchema
        name="QR Code 產生器"
        description="從任何文字或網址即時產生 QR Code。免費線上 QR Code 產生器，支援自訂顏色與大小。"
        url="https://toolcase.cc/zh-tw/everyday/qr-code-generator"
