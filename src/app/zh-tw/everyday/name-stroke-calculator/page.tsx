...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/name-stroke-calculator', languages: { en: 'https://toolcase.cc/everyday/name-stroke-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/name-stroke-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '姓名筆畫吉凶查詢', url: 'https://toolcase.cc/zh-tw/everyday/name-stroke-calculator' },
        ]}
      />
      <ToolSchema
        name="姓名筆畫吉凶查詢"
        description="輸入姓名查詢總筆畫數與吉凶判定，含各字筆畫明細。姓名學筆畫分析工具。"
        url="https://toolcase.cc/zh-tw/everyday/name-stroke-calculator"
