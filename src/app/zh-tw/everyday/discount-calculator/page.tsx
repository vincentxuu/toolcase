...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/discount-calculator', languages: { en: 'https://toolcase.cc/everyday/discount-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/discount-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '折扣計算器', url: 'https://toolcase.cc/zh-tw/everyday/discount-calculator' },
        ]}
      />
      <ToolSchema
        name="折扣計算器"
        description="即時計算折扣後價格、節省金額與折扣百分比。免費線上折扣計算器，購物省錢好幫手。"
        url="https://toolcase.cc/zh-tw/everyday/discount-calculator"
