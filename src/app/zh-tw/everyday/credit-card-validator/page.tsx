...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/credit-card-validator', languages: { en: 'https://toolcase.cc/everyday/credit-card-validator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/credit-card-validator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '信用卡號驗證器', url: 'https://toolcase.cc/zh-tw/everyday/credit-card-validator' },
        ]}
      />
      <ToolSchema
        name="信用卡號驗證器"
        description="使用 Luhn 算法驗證信用卡號碼。檢測卡片類型（Visa、MasterCard、美國運通等）。所有驗證都在您的瀏覽器中進行。"
        url="https://toolcase.cc/zh-tw/everyday/credit-card-validator"
