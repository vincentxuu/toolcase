...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/random-picker', languages: { en: 'https://toolcase.cc/everyday/random-picker', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/random-picker' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '隨機抽選器', url: 'https://toolcase.cc/zh-tw/everyday/random-picker' },
        ]}
      />
      <ToolSchema
        name="隨機抽選器"
        description="從自訂項目清單中隨機抽選。免費線上隨機抽選器，適合抽獎、決策和隨機分組。"
        url="https://toolcase.cc/zh-tw/everyday/random-picker"
