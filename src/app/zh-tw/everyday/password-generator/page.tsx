...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/password-generator', languages: { en: 'https://toolcase.cc/everyday/password-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/password-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '密碼產生器', url: 'https://toolcase.cc/zh-tw/everyday/password-generator' },
        ]}
      />
      <ToolSchema
        name="密碼產生器"
        description="即時產生強密碼。自訂長度和字元類型。所有產生過程都在你的瀏覽器中完成。"
        url="https://toolcase.cc/zh-tw/everyday/password-generator"
