...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/barcode-generator', languages: { en: 'https://toolcase.cc/everyday/barcode-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/barcode-generator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '條碼產生器', url: 'https://toolcase.cc/zh-tw/everyday/barcode-generator' },
        ]}
      />
      <ToolSchema
        name="條碼產生器"
        description="線上產生 Code 128 條碼，輸入文字或數字即可建立。可自訂條碼寬度與高度，下載為 PNG 圖片。"
        url="https://toolcase.cc/zh-tw/everyday/barcode-generator"
