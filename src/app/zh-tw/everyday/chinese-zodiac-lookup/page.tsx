...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/chinese-zodiac-lookup', languages: { en: 'https://toolcase.cc/everyday/chinese-zodiac-lookup', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/chinese-zodiac-lookup' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '生肖查詢', url: 'https://toolcase.cc/zh-tw/everyday/chinese-zodiac-lookup' },
        ]}
      />
      <ToolSchema
        name="生肖查詢"
        description="輸入出生年份立即查詢你的生肖！提供十二生肖五行屬性、性格特質、相合相沖完整對照表。免費線上生肖查詢工具。"
        url="https://toolcase.cc/zh-tw/everyday/chinese-zodiac-lookup"
