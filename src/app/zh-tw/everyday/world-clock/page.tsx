...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/world-clock', languages: { en: 'https://toolcase.cc/everyday/world-clock', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/world-clock' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '世界時鐘', url: 'https://toolcase.cc/zh-tw/everyday/world-clock' },
        ]}
      />
      <ToolSchema
        name="世界時鐘"
        description="查看全球主要城市的當前時間。即時顯示不同時區的時間更新。"
        url="https://toolcase.cc/zh-tw/everyday/world-clock"
