...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/age-calculator', languages: { en: 'https://toolcase.cc/everyday/age-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/age-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '年齡計算器', url: 'https://toolcase.cc/zh-tw/everyday/age-calculator' },
        ]}
      />
      <ToolSchema
        name="年齡計算器"
        description="計算你的精確年齡，以年、月、日表示。查看距離下次生日還有幾天。"
        url="https://toolcase.cc/zh-tw/everyday/age-calculator"
