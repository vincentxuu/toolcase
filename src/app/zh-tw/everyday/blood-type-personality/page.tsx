...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/blood-type-personality', languages: { en: 'https://toolcase.cc/everyday/blood-type-personality', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/blood-type-personality' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '血型性格分析', url: 'https://toolcase.cc/zh-tw/everyday/blood-type-personality' },
        ]}
      />
      <ToolSchema
        name="血型性格分析"
        description="選擇你的血型，查看性格特質、優缺點與配對分析。提供 A、B、O、AB 四大血型完整性格對照表。免費線上血型性格分析工具。"
        url="https://toolcase.cc/zh-tw/everyday/blood-type-personality"
