...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/countdown-timer', languages: { en: 'https://toolcase.cc/everyday/countdown-timer', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/countdown-timer' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '倒數計時器', url: 'https://toolcase.cc/zh-tw/everyday/countdown-timer' },
        ]}
      />
      <ToolSchema
        name="倒數計時器"
        description="設定目標日期，即時倒數計時。免費線上倒數計時器，精確顯示天、時、分、秒。"
        url="https://toolcase.cc/zh-tw/everyday/countdown-timer"
