...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/scientific-calculator', languages: { en: 'https://toolcase.cc/everyday/scientific-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/scientific-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '科學計算機', url: 'https://toolcase.cc/zh-tw/everyday/scientific-calculator' },
        ]}
      />
      <ToolSchema
        name="科學計算機"
        description="免費線上科學計算機，支援三角函數（sin、cos、tan）、對數、平方根、指數和度/弧度切換。"
        url="https://toolcase.cc/zh-tw/everyday/scientific-calculator"
