...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/percentage-calculator', languages: { en: 'https://toolcase.cc/everyday/percentage-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/percentage-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '百分比計算器', url: 'https://toolcase.cc/zh-tw/everyday/percentage-calculator' },
        ]}
      />
      <ToolSchema
        name="百分比計算器"
        description="即時計算百分比。求某數的百分之幾、百分比變化等。"
        url="https://toolcase.cc/zh-tw/everyday/percentage-calculator"
