...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/relative-title-calculator', languages: { en: 'https://toolcase.cc/everyday/relative-title-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/relative-title-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '親戚稱謂計算機', url: 'https://toolcase.cc/zh-tw/everyday/relative-title-calculator' },
        ]}
      />
      <ToolSchema
        name="親戚稱謂計算機"
        description="計算台灣家族關係稱謂。使用此互動工具學習如何稱呼中文家族結構中的親戚。"
        url="https://toolcase.cc/zh-tw/everyday/relative-title-calculator"
