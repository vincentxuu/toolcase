...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/taiwan-postal-code', languages: { en: 'https://toolcase.cc/everyday/taiwan-postal-code', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/taiwan-postal-code' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '台灣郵遞區號查詢', url: 'https://toolcase.cc/zh-tw/everyday/taiwan-postal-code' },
        ]}
      />
      <ToolSchema
        name="台灣郵遞區號查詢"
        description="快速查詢台灣各縣市鄉鎮區的郵遞區號（3碼），支援搜尋、篩選，點擊即複製。"
        url="https://toolcase.cc/zh-tw/everyday/taiwan-postal-code"
