...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/electricity-calculator', languages: { en: 'https://toolcase.cc/everyday/electricity-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/electricity-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '電費計算器', url: 'https://toolcase.cc/zh-tw/everyday/electricity-calculator' },
        ]}
      />
      <ToolSchema
        name="電費計算器"
        description="計算電器的用電成本。輸入瓦數、使用時間和電價，即可查看每日、每月和每年的電費。"
        url="https://toolcase.cc/zh-tw/everyday/electricity-calculator"
