...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/address-translator', languages: { en: 'https://toolcase.cc/everyday/address-translator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/address-translator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '中文地址英譯', url: 'https://toolcase.cc/zh-tw/everyday/address-translator' },
        ]}
      />
      <ToolSchema
        name="中文地址英譯"
        description="將台灣中文地址翻譯成英文，適用於寄國際包裹、填寫英文表格。自動辨識縣市、區域。"
        url="https://toolcase.cc/zh-tw/everyday/address-translator"
