...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/date-calculator', languages: { en: 'https://toolcase.cc/everyday/date-calculator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/date-calculator' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '日期計算器', url: 'https://toolcase.cc/zh-tw/everyday/date-calculator' },
        ]}
      />
      <ToolSchema
        name="日期計算器"
        description="計算兩個日期之間的差異，或從日期加減天數。免費線上日期計算器。"
        url="https://toolcase.cc/zh-tw/everyday/date-calculator"
