...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/everyday/multiplication-table', languages: { en: 'https://toolcase.cc/everyday/multiplication-table', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/everyday/multiplication-table' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '九九乘法表', url: 'https://toolcase.cc/zh-tw/everyday/multiplication-table' },
        ]}
      />
      <ToolSchema
        name="九九乘法表"
        description="互動式九九乘法表，支援 1~19 範圍，點擊格子複製算式。適合學生、家長教學使用。"
        url="https://toolcase.cc/zh-tw/everyday/multiplication-table"
