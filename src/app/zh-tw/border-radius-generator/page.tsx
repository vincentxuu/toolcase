...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/border-radius-generator', languages: { en: 'https://toolcase.cc/border-radius-generator', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/border-radius-generator' } },
}
