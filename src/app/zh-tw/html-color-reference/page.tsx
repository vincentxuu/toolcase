...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/html-color-reference', languages: { en: 'https://toolcase.cc/html-color-reference', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/html-color-reference' } },
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'HTML 顏色代碼表', url: 'https://toolcase.cc/zh-tw/html-color-reference' },
        ]}
      />
      <ToolSchema
        name="HTML 顏色代碼表"
        description="瀏覽所有 140+ 個 HTML 命名顏色與十六進位代碼。可搜尋的顏色參考圖表，適用於網頁開發和設計。"
        url="https://toolcase.cc/zh-tw/html-color-reference"
