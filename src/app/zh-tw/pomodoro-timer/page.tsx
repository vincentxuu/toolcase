...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/pomodoro-timer', languages: { en: 'https://toolcase.cc/pomodoro-timer', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/pomodoro-timer' } },
}
