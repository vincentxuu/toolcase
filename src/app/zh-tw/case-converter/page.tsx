...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://toolcase.cc/zh-tw/case-converter', languages: { en: 'https://toolcase.cc/case-converter', 'zh-Hant-TW': 'https://toolcase.cc/zh-tw/case-converter' } },
}
